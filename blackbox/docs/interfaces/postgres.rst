...
CrateDB::
    ...
    +------+-------------+----------+---------+--------+--------------+---------+-----------+
    |  oid | typbasetype | typdelim | typelem | typlen | typname      | typtype | typtypmod |
    +------+-------------+----------+---------+--------+--------------+---------+-----------+
    |   16 |           0 | ,        |       0 |      1 | bool         | b       |        -1 |
    |   18 |           0 | ,        |       0 |      1 | char         | b       |        -1 |
    |   20 |           0 | ,        |       0 |      8 | int8         | b       |        -1 |
    ...
    |   23 |           0 | ,        |       0 |      4 | int4         | b       |        -1 |
    |  114 |           0 | ,        |       0 |     -1 | json         | b       |        -1 |
    |  199 |           0 | ,        |     114 |     -1 | _json        | b       |        -1 |
    |  700 |           0 | ,        |       0 |      4 | float4       | b       |        -1 |
    |  701 |           0 | ,        |       0 |      8 | float8       | b       |        -1 |
    | 1000 |           0 | ,        |      16 |     -1 | _bool        | b       |        -1 |
    | 1002 |           0 | ,        |      18 |     -1 | _char        | b       |        -1 |
    | 1005 |           0 | ,        |      21 |     -1 | _int2        | b       |        -1 |
    | 1007 |           0 | ,        |      23 |     -1 | _int4        | b       |        -1 |
    | 1015 |           0 | ,        |    1043 |     -1 | _varchar     | b       |        -1 |
    | 1016 |           0 | ,        |      20 |     -1 | _int8        | b       |        -1 |
    | 1021 |           0 | ,        |     700 |     -1 | _float4      | b       |        -1 |
    | 1022 |           0 | ,        |     701 |     -1 | _float8      | b       |        -1 |
    | 1043 |           0 | ,        |       0 |     -1 | varchar      | b       |        -1 |
    | 1184 |           0 | ,        |       0 |      8 | timestamptz  | b       |        -1 |
    | 1185 |           0 | ,        |    1184 |     -1 | _timestamptz | b       |        -1 |
    +------+-------------+----------+---------+--------+--------------+---------+-----------+
