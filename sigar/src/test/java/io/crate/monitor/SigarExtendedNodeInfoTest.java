...
public class SigarExtendedNodeInfoTest extends CrateUnitTest {
    ...
    public void testOsStats() throws Exception {
        ...
        assertThat(stats.probeTimestamp(), greaterThan(0L));
    ...
    public void testOsStatsCache() throws Exception {
        /*
          ...
          the new stats object must have a probe updateTimestamp that is greater/equal than old probe updateTimestamp + cache time
         */
        ...
        while (statsNew.probeTimestamp() != statsOld.probeTimestamp()) {
        ...
        statsNew = extendedNodeInfo.osStats();
        assertTrue(statsNew.probeTimestamp() - statsOld.probeTimestamp() >= cacheTime);
    }
