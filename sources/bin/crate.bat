...
set CRATE_CLASSPATH=%CRATE_CLASSPATH%;%CRATE_HOME%/lib/${project.build.finalName}.jar;%CRATE_HOME%/lib/*;%CRATE_HOME%/lib/sigar/*
set CRATE_PARAMS=-Dcrate -Des-foreground=yes -Des.path.home="%CRATE_HOME%" -Des.config="%CRATE_HOME%/config/crate.yml" -Des.cluster.name="crate"

"%JAVA_HOME%\bin\java" %JAVA_OPTS% %CRATE_JAVA_OPTS% %CRATE_PARAMS% %* -cp "%CRATE_CLASSPATH%" "org.elasticsearch.bootstrap.ElasticSearch"
goto finally
