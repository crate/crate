...
class Netty4HttpRequestHandler extends SimpleChannelInboundHandler<Object> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        final Netty4HttpChannel channel;
        {
            ...
            try {
                innerChannel = new Netty4HttpChannel(serverTransport, httpRequest, detailedErrorsEnabled, threadContext);
                ...
                final Netty4HttpRequest innerRequest =
                        new Netty4HttpRequest(
                                ...
                                copy,
                                ctx.channel());
                innerChannel = new Netty4HttpChannel(serverTransport, innerRequest, detailedErrorsEnabled, threadContext);
            }
