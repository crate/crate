...
import io.crate.es.test.rest.yaml.ObjectPath;
...
import static io.crate.es.common.xcontent.ToXContent.EMPTY_PARAMS;
import static io.crate.es.common.xcontent.XContentHelper.createParser;
