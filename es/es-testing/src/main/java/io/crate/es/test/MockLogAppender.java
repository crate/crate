...
public class MockLogAppender extends AbstractAppender {
    ...
    private static final String COMMON_PREFIX = System.getProperty("es.logger.prefix", "io.crate.es.");
    ...
    private static String getLoggerName(String name) {
        if (name.startsWith("io.crate.es.")) {
            name = name.substring("io.crate.es.".length());
        }
