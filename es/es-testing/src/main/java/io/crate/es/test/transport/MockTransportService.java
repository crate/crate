...
import io.crate.es.test.tasks.MockTaskManager;
...
import io.crate.es.transport.MockTcpTransport;
 ...
 * (for example, @see io.crate.es.discovery.zen.ping.unicast.UnicastZenPing, which constructs
