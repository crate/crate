...
public class TransportAddVotingConfigExclusionsAction extends TransportMasterNodeAction<AddVotingConfigExclusionsRequest,
    ...
    @Inject
    public TransportAddVotingConfigExclusionsAction(Settings settings,
                                                    TransportService transportService,
                                                    ClusterService clusterService,
                                                    ThreadPool threadPool,
                                                    IndexNameExpressionResolver indexNameExpressionResolver) {
        super(settings, AddVotingConfigExclusionsAction.NAME, transportService, clusterService, threadPool,
