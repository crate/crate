...
public class IndexShard extends AbstractIndexShardComponent implements IndicesClusterStateService.Shard {
    ...
    public static Engine.Index prepareIndex(DocumentMapperForType docMapper,
    ...
    private Engine.DeleteResult applyDeleteOperation(Engine engine,
        ...
        try{
            Mapping update = defaultDocMapper().getMapping();
            if (update != null) {
    ...
    private DocumentMapperForType defaultDocMapper() {
        return mapperService.documentMapperWithAutoCreate("default");
    }
    ...
    private EngineConfig.TombstoneDocSupplier tombstoneDocSupplier() {
        ...
        return new EngineConfig.TombstoneDocSupplier() {
            ...
            public ParsedDocument newDeleteTombstoneDoc(String id) {
                return defaultDocMapper().getDocumentMapper().createDeleteTombstoneDoc(shardId.getIndexName(), id);
            }
            @Override
