...
import io.crate.es.indices.cluster.IndicesClusterStateService.AllocatedIndices.IndexRemovalReason;
 ...
 * via {@link io.crate.es.index.IndexModule#addIndexEventListener(IndexEventListener)}. All listeners have the same
...
public interface IndexEventListener {
    ...
    /**
     * Called after a shard's {@link io.crate.es.index.shard.IndexShardState} changes.
