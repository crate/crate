...
public class ClusterStateRequestBuilder extends MasterNodeReadOperationRequestBuilder<ClusterStateRequest, ClusterStateResponse, ClusterStateRequestBuilder> {
    ...
    /**
     * Should the cluster state result include the {@link io.crate.es.cluster.metadata.MetaData}. Defaults
     * to {@code true}.
     */
    ...
    /**
     * Should the cluster state result include the {@link io.crate.es.cluster.node.DiscoveryNodes}. Defaults
     * to {@code true}.
     */
    ...
    /**
     * Should the cluster state result include the {@link io.crate.es.cluster.ClusterState.Custom}. Defaults
     * to {@code true}.
     */
    ...
    /**
     * Should the cluster state result include the {@link io.crate.es.cluster.routing.RoutingTable}. Defaults
     * to {@code true}.
     */
    ...
    /**
     * When {@link #setMetaData(boolean)} is set, which indices to return the {@link io.crate.es.cluster.metadata.IndexMetaData}
