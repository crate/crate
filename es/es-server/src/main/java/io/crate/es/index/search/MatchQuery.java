...
package io.crate.es.index.search;
...
import io.crate.es.common.lucene.search.MultiPhrasePrefixQuery;
...
import static io.crate.es.common.lucene.search.Queries.newLenientFieldQuery;
import static io.crate.es.common.lucene.search.Queries.newUnmappedFieldQuery;
            ...
            try (TokenStream source = analyzer.tokenStream(field, queryText)) {
                if (source.hasAttribute(DisableGraphAttribute.class)) {
                    /*
                      ...
                      paths explosion. See {@link io.crate.es.index.analysis.ShingleTokenFilterFactory} for details.
                     */
