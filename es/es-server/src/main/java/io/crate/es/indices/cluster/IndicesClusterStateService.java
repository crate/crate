...
package io.crate.es.indices.cluster;
...
import io.crate.es.cluster.routing.RecoverySource.Type;
...
import io.crate.es.index.shard.IndexShardRelocatedException;
...
import static io.crate.es.indices.cluster.IndicesClusterStateService.AllocatedIndices.IndexRemovalReason.CLOSED;
import static io.crate.es.indices.cluster.IndicesClusterStateService.AllocatedIndices.IndexRemovalReason.DELETED;
import static io.crate.es.indices.cluster.IndicesClusterStateService.AllocatedIndices.IndexRemovalReason.FAILURE;
...
public class IndicesClusterStateService extends AbstractLifecycleComponent implements ClusterStateApplier {
     ...
     * shard copies to exist in the cluster before deleting shard data (triggered by {@link io.crate.es.indices.store.IndicesStore}).
     *
