...
import io.crate.es.common.cache.Cache;
import io.crate.es.common.cache.CacheBuilder;
import io.crate.es.common.cache.RemovalListener;
import io.crate.es.common.cache.RemovalNotification;
...
import io.crate.es.index.IndexWarmer;
import io.crate.es.index.IndexWarmer.TerminationHandle;
import io.crate.es.index.engine.Engine;
import io.crate.es.index.shard.IndexShard;
import io.crate.es.index.shard.ShardId;
import io.crate.es.index.shard.ShardUtils;
 ...
 * {@link io.crate.es.index.cache.query.QueryCache} should be used instead.
 */
