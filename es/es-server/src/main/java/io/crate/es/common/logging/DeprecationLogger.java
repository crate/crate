...
public class DeprecationLogger {
     ...
     * prefixes the logger name with "deprecation", if it starts with "io.crate.es",
     * it replaces "io.crate.es" with "io.crate.es.deprecation" to maintain
     * the "io.crate.es" namespace.
     */
    public DeprecationLogger(Logger parentLogger) {
        String name = parentLogger.getName();
        if (name.startsWith("io.crate.es")) {
            name = name.replace("io.crate.es.", "io.crate.es.deprecation.");
        } else {
