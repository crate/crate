...
import static io.crate.es.index.seqno.SequenceNumbers.NO_OPS_PERFORMED;
...
public class GlobalCheckpointListeners implements Closeable {
    ...
    public interface GlobalCheckpointListener {
         ...
         * will be set to {@link io.crate.es.index.seqno.SequenceNumbers#UNASSIGNED_SEQ_NO} and the exception will be non-null and an
