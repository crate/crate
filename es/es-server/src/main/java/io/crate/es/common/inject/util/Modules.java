...
import io.crate.es.common.inject.spi.DefaultBindingScopingVisitor;
import io.crate.es.common.inject.spi.DefaultElementVisitor;
...
public final class Modules {
    ...
    public static Module combine(Iterable<? extends Module> modules) {
        final Set<? extends Module> modulesSet = Sets.newHashSet(modules);
        return new Module() {
            @Override
            public void configure(Binder binder) {
