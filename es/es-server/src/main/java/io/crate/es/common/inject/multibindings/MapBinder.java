...
import io.crate.es.common.inject.multibindings.Multibinder.RealMultibinder;
...
public abstract class MapBinder<K, V> {
    ...
    private static <K, V> TypeLiteral<Map<K, Provider<V>>> mapOfProviderOf(
        ...
        return (TypeLiteral<Map<K, Provider<V>>>) TypeLiteral.get(
                Types.mapOf(keyType.getType(), Types.newParameterizedType(Provider.class, valueType.getType())));
    }
    ...
    private static <K, V> TypeLiteral<Map.Entry<K, Provider<V>>> entryOfProviderOf(
            TypeLiteral<K> keyType, TypeLiteral<V> valueType) {
        return (TypeLiteral<Entry<K, Provider<V>>>) TypeLiteral.get(Types.newParameterizedTypeWithOwner(
