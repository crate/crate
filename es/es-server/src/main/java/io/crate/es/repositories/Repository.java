 ...
 * <ul>
 * <li>Master calls {@link #initializeSnapshot(SnapshotId, List, io.crate.es.cluster.metadata.MetaData)}
...
public interface Repository extends LifecycleComponent {
     ...
     * @param verificationToken value returned by {@link io.crate.es.repositories.Repository#startVerification()}
     ...
     * <p>
     * The index commit point can be obtained by using {@link io.crate.es.index.engine.Engine#acquireLastIndexCommit} method.
