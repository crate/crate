...
public final class EngineConfig {
    ...
    /**
     * Creates a new {@link io.crate.es.index.engine.EngineConfig}
     */
     ...
     * {@link io.crate.es.threadpool.ThreadPool#relativeTimeInMillis()} and to schedule
     * async force merge calls on the {@link io.crate.es.threadpool.ThreadPool.Names#FORCE_MERGE} thread-pool
     */
    ...
    /**
     * Returns an {@link io.crate.es.index.engine.Engine.Warmer} used to warm new searchers before they are used for searching.
     */
    ...
    /**
     * Returns the {@link io.crate.es.index.store.Store} instance that provides access to the
