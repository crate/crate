 ...
 * and notifies the {@link io.crate.es.discovery.Discovery.AckListener}
...
public class AckClusterStatePublishResponseHandler extends BlockingClusterStatePublishResponseHandler {
     ...
     * @param ackListener the {@link io.crate.es.discovery.Discovery.AckListener} to notify for each response
