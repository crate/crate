...
package io.crate.es.common.geo.builders;

import io.crate.es.common.geo.GeoShapeType;
import io.crate.es.common.geo.XShapeCollection;
import io.crate.es.common.geo.parsers.GeoWKTParser;
import io.crate.es.common.geo.parsers.ShapeParser;
...
public class MultiPolygonBuilder extends ShapeBuilder {
    ...
    private static String polygonCoordinatesToWKT(PolygonBuilder polygon) {
        ...
        sb.append(coordinateListToWKT(polygon.shell().coordinates));
        for (LineStringBuilder hole : polygon.holes()) {
            sb.append(GeoWKTParser.COMMA);
            sb.append(coordinateListToWKT(hole.coordinates));
        }
