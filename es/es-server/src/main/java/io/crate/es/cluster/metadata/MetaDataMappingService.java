...
import io.crate.es.action.admin.indices.mapping.put.PutMappingClusterStateUpdateRequest;
...
import io.crate.es.index.mapper.MapperService.MergeReason;
import io.crate.es.indices.IndicesService;
import io.crate.es.indices.InvalidTypeNameException;
...
import static io.crate.es.indices.cluster.IndicesClusterStateService.AllocatedIndices.IndexRemovalReason.NO_LONGER_ASSIGNED;
