...
import io.crate.es.common.geo.SpatialStrategy;
...
import static io.crate.es.index.mapper.GeoPointFieldMapper.Names.IGNORE_MALFORMED;

/**
 * FieldMapper for indexing {@link org.locationtech.spatial4j.shape.Shape}s.
 * <p>
 * Currently Shapes can only be indexed and can only be queried using
 * {@link io.crate.es.index.query.GeoShapeQueryBuilder}, consequently
