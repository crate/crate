...
import static io.crate.es.common.util.CollectionUtils.asArrayList;
...
public class Loggers {
    ...
    public static Logger getLogger(Class<?> clazz, ShardId shardId, String... prefixes) {
        return getLogger(clazz, shardId.getIndex(), CollectionUtils.asArrayList(Integer.toString(shardId.id()), prefixes).toArray(new String[0]));
    }
    ...
    public static Logger getLogger(Class<?> clazz, Index index, String... prefixes) {
        return getLogger(clazz, CollectionUtils.asArrayList(Loggers.SPACE, index.getName(), prefixes).toArray(new String[0]));
    }
