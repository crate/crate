...
import io.crate.es.index.fielddata.plain.BytesBinaryDVIndexFieldData;
import io.crate.es.index.query.QueryShardContext;
import io.crate.es.index.query.QueryShardException;
...
import static io.crate.es.index.mapper.TypeParsers.parseField;
