...
package io.crate.es.common.blobstore.fs;
...
/**
 * A file system based implementation of {@link BlobContainer}.
 * All blobs in the container are stored on a file system, the location of which is specified by the {@link BlobPath}.
 *
 * Note that the methods in this implementation of {@link BlobContainer} may
