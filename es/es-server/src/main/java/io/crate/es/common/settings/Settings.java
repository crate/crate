...
import io.crate.es.common.unit.RatioValue;
import io.crate.es.common.unit.SizeValue;
...
import io.crate.es.common.xcontent.XContentParserUtils;
...
import static io.crate.es.common.unit.ByteSizeValue.parseBytesSizeValue;
import static io.crate.es.common.unit.SizeValue.parseSizeValue;
import static io.crate.es.common.unit.TimeValue.parseTimeValue;
...
public final class Settings implements ToXContentFragment {
     ...
     * {@link Setting} object constructed in, for example, {@link io.crate.es.env.Environment}.
     */
    ...
    public TimeValue getAsTime(String setting, TimeValue defaultValue) {
        return TimeValue.parseTimeValue(get(setting), defaultValue, setting);
    }
    ...
    public ByteSizeValue getAsBytesSize(String setting, ByteSizeValue defaultValue) throws SettingsException {
        return ByteSizeValue.parseBytesSizeValue(get(setting), defaultValue, setting);
    }
