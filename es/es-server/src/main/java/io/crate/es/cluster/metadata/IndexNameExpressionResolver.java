...
import io.crate.es.common.time.DateMathParser;
import io.crate.es.common.time.DateUtils;
import io.crate.es.common.util.set.Sets;
import io.crate.es.index.Index;
import io.crate.es.index.IndexNotFoundException;
import io.crate.es.indices.IndexClosedException;
...
public class IndexNameExpressionResolver extends AbstractComponent {
     ...
     * Callers should make sure they provide proper {@link io.crate.es.action.support.IndicesOptions}
