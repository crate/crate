...
/**
 * This {@link io.crate.es.cluster.routing.allocation.decider.AllocationDecider} prevents shards that
...
public class SnapshotInProgressAllocationDecider extends AllocationDecider {
    ...
    /**
     * Creates a new {@link io.crate.es.cluster.routing.allocation.decider.SnapshotInProgressAllocationDecider} instance from
     * given settings
     *
