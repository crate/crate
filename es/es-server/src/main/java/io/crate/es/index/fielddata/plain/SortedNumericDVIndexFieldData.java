...
import io.crate.es.index.fielddata.AtomicNumericFieldData;
import io.crate.es.index.fielddata.FieldData;
import io.crate.es.index.fielddata.IndexNumericFieldData;
import io.crate.es.index.fielddata.NumericDoubleValues;
import io.crate.es.index.fielddata.SortedNumericDoubleValues;
import io.crate.es.index.fielddata.fieldcomparator.DoubleValuesComparatorSource;
import io.crate.es.index.fielddata.fieldcomparator.FloatValuesComparatorSource;
import io.crate.es.index.fielddata.fieldcomparator.LongValuesComparatorSource;
