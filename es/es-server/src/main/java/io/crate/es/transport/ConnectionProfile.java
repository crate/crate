 ...
 * ({@link io.crate.es.transport.TransportRequestOptions.Type}). This allows to tailor a connection towards a specific usage.
 */
public final class ConnectionProfile {
    ...
    public static class Builder {
         ...
         * @throws IllegalStateException if any of the {@link io.crate.es.transport.TransportRequestOptions.Type} enum is missing
         */
