...
import io.crate.es.cluster.Diff;
import io.crate.es.cluster.Diffable;
import io.crate.es.cluster.DiffableUtils;
import io.crate.es.cluster.block.ClusterBlock;
import io.crate.es.cluster.block.ClusterBlockLevel;
import io.crate.es.cluster.node.DiscoveryNodeFilters;
import io.crate.es.cluster.routing.allocation.IndexMetaDataUpdater;
import io.crate.es.common.Nullable;
import io.crate.es.common.bytes.BytesArray;
import io.crate.es.common.collect.ImmutableOpenIntMap;
...
import io.crate.es.gateway.MetaDataStateFormat;
...
import static io.crate.es.cluster.node.DiscoveryNodeFilters.IP_VALIDATOR;
import static io.crate.es.cluster.node.DiscoveryNodeFilters.OpType.AND;
import static io.crate.es.cluster.node.DiscoveryNodeFilters.OpType.OR;
...
public class IndexMetaData implements Diffable<IndexMetaData>, ToXContentFragment {
    ...
    public static class Builder {
        ...
        public static IndexMetaData fromXContent(XContentParser parser) throws IOException {
            ...
            if (Assertions.ENABLED && Version.indexCreated(builder.settings).onOrAfter(Version.ES_V_6_5_1)) {
     ...
     * {@link io.crate.es.cluster.routing.OperationRouting#generateShardId(IndexMetaData, String, String)} to route documents
     ...
     * {@link io.crate.es.cluster.routing.OperationRouting#generateShardId(IndexMetaData, String, String)} to guarantee consistent
