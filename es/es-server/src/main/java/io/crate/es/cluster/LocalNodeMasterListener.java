...
public interface LocalNodeMasterListener {
     ...
     * the work done is the callbacks above is inexpensive, this value may be {@link io.crate.es.threadpool.ThreadPool.Names#SAME SAME}
     ...
     * prefer to execute them on a separate more appropriate executor (eg. {@link io.crate.es.threadpool.ThreadPool.Names#GENERIC GENERIC}
     * or {@link io.crate.es.threadpool.ThreadPool.Names#MANAGEMENT MANAGEMENT}).
     *
