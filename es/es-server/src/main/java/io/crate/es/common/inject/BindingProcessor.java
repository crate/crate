...
import io.crate.es.common.inject.internal.Annotations;
import io.crate.es.common.inject.internal.BindingImpl;
import io.crate.es.common.inject.internal.Errors;
import io.crate.es.common.inject.internal.ErrorsException;
import io.crate.es.common.inject.internal.ExposedBindingImpl;
import io.crate.es.common.inject.internal.InstanceBindingImpl;
import io.crate.es.common.inject.internal.InternalFactory;
import io.crate.es.common.inject.internal.LinkedBindingImpl;
import io.crate.es.common.inject.internal.LinkedProviderBindingImpl;
import io.crate.es.common.inject.internal.ProviderInstanceBindingImpl;
import io.crate.es.common.inject.internal.ProviderMethod;
import io.crate.es.common.inject.internal.Scoping;
import io.crate.es.common.inject.internal.UntargettedBindingImpl;
import io.crate.es.common.inject.spi.BindingTargetVisitor;
import io.crate.es.common.inject.spi.ConstructorBinding;
import io.crate.es.common.inject.spi.ConvertedConstantBinding;
...
import io.crate.es.common.inject.spi.ProviderBinding;
import io.crate.es.common.inject.spi.ProviderInstanceBinding;
import io.crate.es.common.inject.spi.ProviderKeyBinding;
...
class BindingProcessor extends AbstractProcessor {
    ...
    // all our unit tests.
    private static final Set<Class<?>> FORBIDDEN_TYPES = unmodifiableSet(Sets.newHashSet(
