...
import io.crate.es.action.support.TransportActions;
...
import io.crate.es.action.support.broadcast.BroadcastShardOperationFailedException;
...
import io.crate.es.common.util.concurrent.CountDown;
...
public abstract class TransportBroadcastReplicationAction<Request extends BroadcastRequest<Request>, Response extends BroadcastResponse, ShardRequest extends ReplicationRequest<ShardRequest>, ShardResponse extends ReplicationResponse>
    ...
    public TransportBroadcastReplicationAction(String name, Supplier<Request> request, Settings settings, ThreadPool threadPool, ClusterService clusterService,
                                               ...
                                               IndexNameExpressionResolver indexNameExpressionResolver, TransportReplicationAction replicatedBroadcastShardAction) {
        super(settings, name, threadPool, transportService, indexNameExpressionResolver, request);
