...
public class CrossJoinBlockNLBatchIteratorTest {
    ...
    public static Stream<Params> parameters() throws Exception {
        return Stream.of(
    ...
    void testNestedLoopBatchIterator(Params params) throws Exception {
    ...
    @ParameterizedTest
    @MethodSource("parameters")
    void testNestedLoopWithBatchedSource(Params params) throws Exception {
        int batchSize = 50;
        BatchIteratorTester tester = new BatchIteratorTester(
            () -> new CrossJoinBlockNLBatchIterator(
    ...
    @ParameterizedTest
    @MethodSource("parameters")
    void testNestedLoopLeftAndRightEmpty(Params params) throws Exception {
    ...
    @MethodSource("parameters")
    void testNestedLoopLeftEmpty(Params params) throws Exception {
        BatchIterator<Row> iterator = new CrossJoinBlockNLBatchIterator(
            InMemoryBatchIterator.empty(SENTINEL),
            params.right.get(),
            new CombinedRow(0, 1),
    ...
    @ParameterizedTest
    @MethodSource("parameters")
    void testNestedLoopRightEmpty(Params params) throws Exception {
        BatchIterator<Row> iterator = new CrossJoinBlockNLBatchIterator(
            params.left.get(),
            InMemoryBatchIterator.empty(SENTINEL),
            new CombinedRow(1, 0),
    ...
    @ParameterizedTest
    @MethodSource("parameters")
    void testMoveToStartWhileRightSideIsActive(Params params) {
