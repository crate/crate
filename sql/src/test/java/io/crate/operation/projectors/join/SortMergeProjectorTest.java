...
public class SortMergeProjectorTest extends RandomizedTest {
    ...
    private Object[][] executeSortMerge(int offset, int limit, Object[][] leftRows, Object[][] rightRows) throws Exception {
        CollectExpression[] leftCollectExpressions = new CollectExpression[] { new InputCollectExpression(0) };
    ...
    public void testFromDifferentThreads() throws Exception {
        ...
        Object[][] result = executeSortMerge(
                0,
                10,
                toOneColRows(0, 0, 1, 2, 2, 3, 4),
                toOneColRows(1, 1, 2, 2, 2, 3));
        assertThat(
    ...
    public void testBothSidesEmpty() throws Exception {
        Object[][] result = executeSortMerge(0, 10, toOneColRows(), toOneColRows());
        assertThat(
                TestingHelpers.printedTable(result),
                is("")
        );
    ...
    public void testLeftSideEmpty() throws Exception {
        Object[][] result = executeSortMerge(0, 10, toOneColRows(), toOneColRows(1, 2, 3));
        assertThat(
                TestingHelpers.printedTable(result),
                is("")
        );
    ...
    public void testRightSideEmpty() throws Exception {
        Object[][] result = executeSortMerge(0, 10, toOneColRows(1, 2, 3), toOneColRows());
        assertThat(
                TestingHelpers.printedTable(result),
                is("")
        );
    ...
    public void testWithOffset() throws Exception {
        Object[][] result = executeSortMerge(1, 10, toOneColRows(1, 2, 3), toOneColRows(1, 2, 3, 3));
        assertThat(
                TestingHelpers.printedTable(result),
                is("2| 2\n3| 3\n3| 3\n")
        );
    ...
    public void testWithLimitHit() throws Exception {
        Object[][] result = executeSortMerge(1, 4, toOneColRows(1, 1, 2, 2, 3, 4), toOneColRows(1, 2, 3, 3));
        assertThat(
                TestingHelpers.printedTable(result),
                is("1| 1\n2| 2\n2| 2\n3| 3\n")
        );
    ...
    public void testWithHighOffset() throws Exception {
        Object[][] result = executeSortMerge(200, 4, toOneColRows(1, 1, 2, 2, 3, 4), toOneColRows(1, 2, 3, 3));
        assertThat(
                TestingHelpers.printedTable(result),
                is("")
        );
    ...
    public void testNoMatch() throws Exception {
        Object[][] result = executeSortMerge(200, 4, toOneColRows(1, 1, 3, 5, 7, 7), toOneColRows(2, 4, 4, 6, 8));
        assertThat(
                TestingHelpers.printedTable(result),
                is("")
        );
