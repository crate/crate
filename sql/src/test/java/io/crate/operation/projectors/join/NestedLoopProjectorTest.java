...
public class NestedLoopProjectorTest extends RandomizedTest {
    ...
    private Bucket executeNestedLoop(List<Row> leftRows, List<Row> rightRows) throws Exception {
        ...
        final RowDownstreamHandle left = nlProjector.leftDownstreamHandle();
        final RowDownstreamHandle right = nlProjector.rightDownstreamHandle();

        CollectingProjector collectingProjector = new CollectingProjector();
        nlProjector.downstream(collectingProjector);
        nlProjector.startProjection(mock(ExecutionState.class));
