...
public class SysNodesExpressionsTest extends CrateDummyClusterServiceUnitTest {
    ...
    public void testName() throws Exception {
        ...
        @SuppressWarnings("unchecked") SimpleObjectExpression<BytesRef> name =
            (SimpleObjectExpression<BytesRef>) nodeSysExpression.getChildImplementation(refInfo.ident().columnIdent().name());
    ...
    public void testHostname() throws Exception {
        ...
        @SuppressWarnings("unchecked") SimpleObjectExpression<BytesRef> expression =
            (SimpleObjectExpression) nodeSysExpression.getChildImplementation(refInfo.ident().columnIdent().name());
