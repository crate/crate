...
public class SysNodeChecksTest extends CrateUnitTest {
    ...
    private final ClusterService clusterService = mock(ClusterService.class, Answers.RETURNS_DEEP_STUBS.get());
    ...
    public void setNodeId() {
        when(clusterService.localNode().id()).thenReturn("node-id");
    }
    ...
    public void testRecoveryExpectedNodesCheckWithDefaultSetting() {
        ...
        assertThat(recoveryExpectedNodesCheck.nodeId().utf8ToString(), is("node-id"));
    ...
    public void testRecoveryAfterNodesCheckWithDefaultSetting() {
        ...
        assertThat(recoveryAfterNodesCheck.nodeId().utf8ToString(), is("node-id"));
    ...
    public void testJvmVersion() {
        ...
        assertThat(jvmVersionSysCheck.nodeId().utf8ToString(), is("node-id"));
