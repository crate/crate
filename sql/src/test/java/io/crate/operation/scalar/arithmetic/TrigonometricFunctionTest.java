...
public class TrigonometricFunctionTest extends AbstractScalarFunctionsTest {
    ...
    public void testNormalize() throws Exception {
        ...
        assertNormalize("asin(cast (0 as long))", isLiteral(0.0, DataTypes.DOUBLE));
        ...
        assertNormalize("cos(cast (3 as long))", isLiteral(-0.9899924966004454, DataTypes.DOUBLE));
        ...
        assertNormalize("acos(cast (0 as long))", isLiteral(1.5707963267948966, DataTypes.DOUBLE));
        ...
        assertNormalize("tan(cast (3 as long))", isLiteral(-0.1425465430742778, DataTypes.DOUBLE));
        ...
        assertNormalize("atan(cast (0 as long))", isLiteral(0.0, DataTypes.DOUBLE));
