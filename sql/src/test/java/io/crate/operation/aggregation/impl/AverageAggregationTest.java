...
public class AverageAggregationTest extends AggregationTest {
    ...
    public void testReturnType() throws Exception {
        ...
        assertEquals(DataTypes.DOUBLE, getFunction("avg", ImmutableList.of(DataTypes.INTEGER)).info().returnType());
        assertEquals(DataTypes.DOUBLE, getFunction("mean", ImmutableList.of(DataTypes.INTEGER)).info().returnType());
    }
