...
public class KeepAliveTimersTest extends CrateUnitTest {
    ...
    private long originalKeepAlive;
    ...
    public void prepare() throws Exception {
        ...
        originalKeepAlive = JobContextService.KEEP_ALIVE;
        JobContextService.KEEP_ALIVE = TEST_DELAY;
    ...
    public void cleanup() throws Exception {
        ...
        JobContextService.KEEP_ALIVE = originalKeepAlive;
    }
    ...
    private Tuple<SettableFuture<Void>, KeepAliveTimers.ResettableTimer> getTimer(TimeValue timerDelay) {
        KeepAliveTimers keepAliveTimers = new KeepAliveTimers(threadPool, transportKeepAliveAction);
