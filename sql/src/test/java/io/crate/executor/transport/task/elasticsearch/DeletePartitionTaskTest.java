...
public class DeletePartitionTaskTest extends CrateDummyClusterServiceUnitTest {
    ...
    public void testIndexNameGeneration() throws Exception {
        ...
        DeletePartitionTask task = new DeletePartitionTask(plan, e.functions(), mock(TransportDeleteIndexAction.class));
        assertThat(
            task.getIndices(new RowN(args1)),
            Matchers.containsInAnyOrder(".partitioned.parted_pks.04732cpp6ks3ed1o60o30c1g"));

        Object[] args2 = {"1395961200000"};
        assertThat(
            task.getIndices(new RowN(args2)),
