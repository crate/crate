...
public class ShardUpsertRequestTest {
    ...
    public void testStreaming() throws Exception {
        ...
        assertThat(request2.assignmentsColumns(), is(assignmentColumns));
        assertThat(request2.missingAssignmentsColumns(), is(missingAssignmentColumns));
        ...
        assertNull(item1.assignments());
        assertThat(item1.missingAssignments(), is(new Object[]{99, new BytesRef("Marvin")}));
        ...
        assertThat(item2.assignments(), is(new Symbol[]{Literal.newLiteral(42), Literal.newLiteral("Deep Thought") }));
        assertNull(item2.missingAssignments());
