...
public class TransportSQLActionClassLifecycleTest extends ClassLifecycleIntegrationTest {
    ...
    public void testJobLog() throws Exception {
        ...
        executor.exec("reset global transient stats.enabled, stats.jobs_log_size");
    ...
    public void testSetSingleStatement() throws Exception {
        ...
        response = executor.exec("reset global persistent stats.enabled, stats.jobs_log_size");
        assertThat(response.rowCount(), is(1L));
    ...
    public void testSetMultipleStatement() throws Exception {
        ...
        response = executor.exec("reset global persistent stats.operations_log_size, stats.enabled");
        assertThat(response.rowCount(), is(1L));
    ...
    public void testSysOperationsLog() throws Exception {
        ...
        executor.exec("reset global transient stats.enabled, stats.operations_log_size");
