...
public class BelowMinNumberOfNodesITest extends SQLTransportIntegrationTest {
    ...
    private int getRestStatus() throws IOException {
        ...
        InetSocketTransportAddress address = (InetSocketTransportAddress) httpTransport.boundAddress().publishAddress();
        HttpGet httpGet = new HttpGet("http://" + address.getHost() + ":" + address.getPort() + "/");
