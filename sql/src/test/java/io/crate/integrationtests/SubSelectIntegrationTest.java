...
public class SubSelectIntegrationTest extends SQLTransportIntegrationTest {
    ...
    @Test
    public void testSubqueryExpressionWithLeftHandFieldSymbolInOperator() throws Exception {
        setup.setUpCharacters();
    ...
    @Test
    public void testSubqueryExpressionWithLeftHandValueSymbolInOperator() throws Exception {
    ...
    @Test
    public void testSubqueryExpressionEvaluatesToNull() throws Exception {
