...
public class TransportSQLActionTest extends SQLTransportIntegrationTest {
    ...
    @Test
    @UseJdbc(false) // FIXME: geo_point support is missing
    ...
    @Test
    @UseJdbc(false) // FIXME: geo type support missing
    ...
    @Test
    @UseJdbc(false) // FIXME: geo_point/shape support is missing
    ...
    @Test
    @UseJdbc(false) // TODO: figure out why this fails
