...
public class SQLRequestTest extends CrateUnitTest {
    ...
    public void testSerializationWriteTo() throws Exception {
        ...
        request.setFetchProperties(new FetchProperties(20, true));
        ...
        byte[] expectedBytes = new byte[]
            {0, 19, 115, 101, 108, 101, 99, 116, 32, 42, 32, 102, 114, 111, 109, 32, 117, 115, 101, 114, 115, 1, 20, 1, 2, 0, 4, 97, 114, 103, 49, 0, 4, 97, 114, 103, 50};
