...
public class SysNodesExpressionsTest extends CrateDummyClusterServiceUnitTest {
    ...
    public void testLoad() throws Exception {
        ...
        io.crate.execution.expression.reference.NestedObjectExpression load =
            (io.crate.execution.expression.reference.NestedObjectExpression) nodeSysExpression.getChildImplementation(refInfo.ident().columnIdent().name());
    ...
    public void testPorts() throws Exception {
        ...
        io.crate.execution.expression.reference.NestedObjectExpression port =
            (io.crate.execution.expression.reference.NestedObjectExpression) nodeSysExpression.getChildImplementation(refInfo.ident().columnIdent().name());
    ...
    public void testMemory() throws Exception {
        ...
        io.crate.execution.expression.reference.NestedObjectExpression mem =
            (io.crate.execution.expression.reference.NestedObjectExpression) nodeSysExpression.getChildImplementation(refInfo.ident().columnIdent().name());
    ...
    public void testHeap() throws Exception {
        ...
        io.crate.execution.expression.reference.NestedObjectExpression heap =
            (io.crate.execution.expression.reference.NestedObjectExpression) nodeSysExpression.getChildImplementation(refInfo.ident().columnIdent().name());
    ...
    public void testFs() throws Exception {
        ...
        io.crate.execution.expression.reference.NestedObjectExpression fs =
            (io.crate.execution.expression.reference.NestedObjectExpression) nodeSysExpression.getChildImplementation(refInfo.ident().columnIdent().name());
        ...
        for (io.crate.execution.expression.reference.NestedObjectExpression exp : dataRef.getChildImplementations()) {
            assertThat(
    ...
    public void testVersion() throws Exception {
        ...
        io.crate.execution.expression.reference.NestedObjectExpression version =
            (io.crate.execution.expression.reference.NestedObjectExpression) nodeSysExpression.getChildImplementation(refInfo.ident().columnIdent().name());
    ...
    public void testNetwork() throws Exception {
        ...
        io.crate.execution.expression.reference.NestedObjectExpression networkRef =
            (io.crate.execution.expression.reference.NestedObjectExpression) nodeSysExpression.getChildImplementation(refInfo.ident().columnIdent().name());
    ...
    public void testNetworkTCP() throws Exception {
        ...
        io.crate.execution.expression.reference.NestedObjectExpression network = (io.crate.execution.expression.reference.NestedObjectExpression) nodeSysExpression.getChildImplementation(columnIdent.name());
    ...
    public void testCpu() throws Exception {
        ...
        io.crate.execution.expression.reference.NestedObjectExpression os =
            (io.crate.execution.expression.reference.NestedObjectExpression) nodeSysExpression.getChildImplementation(refInfo.ident().columnIdent().name());
    ...
    public void testProcess() throws Exception {
        ...
        io.crate.execution.expression.reference.NestedObjectExpression processRef = (io.crate.execution.expression.reference.NestedObjectExpression)
    ...
    public void testOsInfo() throws Exception {
        ...
        io.crate.execution.expression.reference.NestedObjectExpression ref =
            (io.crate.execution.expression.reference.NestedObjectExpression) nodeSysExpression.getChildImplementation(refInfo.ident().columnIdent().name());
    ...
    public void testNestedBytesRefExpressionsString() throws Exception {
        ...
        io.crate.execution.expression.reference.NestedObjectExpression version =
            (io.crate.execution.expression.reference.NestedObjectExpression) nodeSysExpression.getChildImplementation(versionColIdent.name());
