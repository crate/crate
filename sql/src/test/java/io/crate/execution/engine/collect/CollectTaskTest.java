...
public class CollectTaskTest extends RandomizedTest {
    ...
    public void testThreadPoolNameForDocTables() throws Exception {
        String threadPoolExecutorName = MapSideDataCollectOperation.threadPoolName(collectPhase, true);
    ...
    public void testThreadPoolNameForNonDocTables() throws Exception {
        ...
        threadPoolExecutorName = MapSideDataCollectOperation.threadPoolName(collectPhase, true);
        assertThat(threadPoolExecutorName, is(ThreadPool.Names.SEARCH));
        ...
        // information_schema.*
        when(collectPhase.maxRowGranularity()).thenReturn(RowGranularity.DOC);
        threadPoolExecutorName = MapSideDataCollectOperation.threadPoolName(collectPhase, false);
