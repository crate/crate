...
public class HandlerSideLevelCollectTest extends SQLTransportIntegrationTest {
    ...
    public void testInformationSchemaColumns() throws Exception {
        ...
        String expected =
            ...
            "NULL| NULL| NULL| NULL| NULL| NULL| NULL| NULL| NULL| NULL| NULL| license['expirationDateInMs']| timestamp| 3| NULL| NULL| NULL| NULL| NULL| NULL| false| true| NULL| NULL| NULL| NULL| sys| cluster| sys| NULL| NULL| NULL\n" +
