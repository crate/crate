...
public class JoinTest extends CrateDummyClusterServiceUnitTest {
    ...
    public void testNestedLoop_TablesAreNotSwitchedIfLeftHasAPushedDownOrderBy() {
        ...
        LogicalPlan operator = JoinPlanBuilder
            .createNodes(mss, mss.where(), subqueryPlanner, e.functions(), txnCtx, Set.of(), tableStats);
    ...
    public void test_subscript_inside_query_spec_of_a_join_is_part_of_the_source_outputs() {
        ...
        var expectedPlan =
            ...
            "    Collect[doc.users | [id, other_id, name, text, no_index, details, address, awesome, counters, friends, tags, bytes, shorts, date, shape, ints, floats, address['postcode']] | All]\n" +
            "    --- INNER ---\n" +
            "    Boundary[a, x, i]\n" +
