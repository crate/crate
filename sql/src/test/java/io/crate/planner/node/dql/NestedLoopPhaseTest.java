...
public class NestedLoopPhaseTest extends CrateUnitTest {
    ...
    public void testSerialization() throws Exception {
        ...
        NestedLoopPhase node = new NestedLoopPhase(jobId, 1, "nestedLoop", ImmutableList.<Projection>of(topNProjection),
                new MergePhase(jobId, 2, "merge", 1, ImmutableList.<DataType>of(DataTypes.STRING), ImmutableList.<Projection>of()),
                new MergePhase(jobId, 3, "merge", 1, ImmutableList.<DataType>of(DataTypes.STRING), ImmutableList.<Projection>of()),
