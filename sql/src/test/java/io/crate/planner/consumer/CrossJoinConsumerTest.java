...
import static io.crate.testing.TestingHelpers.isInputColumn;
...
public class CrossJoinConsumerTest extends CrateUnitTest {
    ...
    private final Planner.Context plannerContext = new Planner.Context(clusterService, UUID.randomUUID());
    ...
    private class TestModule implements Module {
        ...
        public void configure(Binder binder) {
            binder.bind(ReferenceResolver.class).toInstance(mock(ReferenceResolver.class));
