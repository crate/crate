...
public class GroupByPlannerTest extends CrateUnitTest {
    ...
    public void testGroupByWithAggregationPlan() throws Exception {
        ...
        assertThat(mergePhase.projections().size(), is(2)); // for the default limit there is always a TopNProjection
        assertThat(mergePhase.projections().get(1), instanceOf(TopNProjection.class));
    ...
    public void testGroupByWithAggregationAndLimit() throws Exception {
        ...
        TopNProjection topN = (TopNProjection) mergePhase.projections().get(1);
        assertThat(topN.limit(), is(2));
        assertThat(topN.offset(), is(0));

        // local merge
        mergePhase = distributedGroupByMerge.mergePhase();
    ...
    public void testNonDistributedGroupByOnClusteredColumnSorted() throws Exception {
        ...
        MergePhase mergePhase = merge.mergePhase();
        assertThat(mergePhase.projections().size(), is(1));
        TopNProjection projection = (TopNProjection) mergePhase.projections().get(0);
