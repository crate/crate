...
import io.crate.analyze.AlterPartitionedTableSettingsInfo;
...
public class TestingTableInfo extends AbstractTableInfo {
    ...
    public TestingTableInfo(List<ReferenceInfo> columns,
        ...
        if (partitionedByColumns.isEmpty()) {
            tableSettingsInfo = new TableSettingsInfo();
        } else {
            tableSettingsInfo = new AlterPartitionedTableSettingsInfo();
        }
    }
