...
public class CreateAlterTableStatementAnalyzerTest extends BaseAnalyzerTest {
    ...
    public void testSimpleCreateTable() throws Exception {
        ...
        assertThat(analysis.tableSettings().settings().get(TableSettingsInfo.NUMBER_OF_SHARDS), is("3"));
        assertThat(analysis.tableSettings().settings().get(TableSettingsInfo.NUMBER_OF_REPLICAS), is("0"));
    ...
    public void testCreateTableWithRefreshInterval() throws Exception {
        ...
        assertThat(analysis.tableSettings().settings().get(TableSettingsInfo.REFRESH_INTERVAL), is("5000"));
    }
    ...
    public void testAlterTableWithRefreshInterval() throws Exception {
        ...
        assertEquals("5000", analysisSet.tableSettings().settings().get(TableSettingsInfo.REFRESH_INTERVAL));

        // alter t reset
        AlterTableAnalysis analysisReset = (AlterTableAnalysis)analyze(
                "ALTER TABLE user_refresh_interval " +
                "RESET (refresh_interval)");
        assertEquals("1000", analysisReset.tableSettings().settings().get(TableSettingsInfo.REFRESH_INTERVAL));
    }
    ...
    public void textCreateTableWithCustomAnalyzerInNestedColumn() throws Exception {
        ...
        assertThat(analysis.tableSettings().settings().get("search"), is("foobar"));
    }
    ...
    public void testChangeNumberOfReplicas() throws Exception {
        ...
        assertThat(analysis.tableSettings().settings().get(TableSettingsInfo.NUMBER_OF_REPLICAS), is("2"));
    }
    ...
    public void testResetNumberOfReplicas() throws Exception {
        ...
        assertThat(analysis.table().ident().name(), is("users"));
        assertThat(analysis.tableSettings().settings().get(TableSettingsInfo.NUMBER_OF_REPLICAS), is("1"));
        assertThat(analysis.tableSettings().settings().get(TableSettingsInfo.AUTO_EXPAND_REPLICAS), is("false"));
    }
    ...
    public void createTableNegativeReplicas() throws Exception {
        ...
        assertThat(analysis.tableSettings().settings().getAsInt(TableSettingsInfo.NUMBER_OF_REPLICAS, 0), is(-1));
    }
    ...
    public void testCreateTableWithClusteredIntoShardsParameter() throws Exception {
        ...
        assertThat(analysis.tableSettings().settings().get(TableSettingsInfo.NUMBER_OF_SHARDS), is("2"));
    }
