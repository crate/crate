...
public class IdTest extends CrateUnitTest {
    ...
    public void testAutoGenerated() throws Exception {
        String id1 = Id.generateId(_ID_LIST, EMPTY_PK_VALUES, _ID);
        String id2 = Id.generateId(_ID_LIST, EMPTY_PK_VALUES, _ID);
    ...
    public void testAutoGeneratedWithRouting() throws Exception {
        ...
        String id1 = Id.generateId(_ID_LIST, EMPTY_PK_VALUES, ci("foo"));
        String id2 = Id.generateId(_ID_LIST, EMPTY_PK_VALUES, ci("foo"));
    ...
    public void testSinglePrimaryKey() throws Exception {
        String id = Id.generateId(ImmutableList.of(ci("id")), ImmutableList.of(new BytesRef("1")), ci("id"));
    ...
    public void testSinglePrimaryKeyWithoutValue() throws Exception {
        ...
        Id.generateId(ImmutableList.of(ci("id")), ImmutableList.<BytesRef>of(), ci("id"));
    }
    ...
    public void testNull() throws Exception {
        ...
        Id.generateId(ImmutableList.of(ci("id")), Collections.<BytesRef>singletonList(null), ci("id"));
    }
}
