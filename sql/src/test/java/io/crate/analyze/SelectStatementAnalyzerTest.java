...
public class SelectStatementAnalyzerTest extends CrateUnitTest {
    ...
    public void testUnion2Tables() throws Exception {
        ...
        assertThat(tableUnion.querySpec().limit().get(), isLiteral(10L));
        assertThat(tableUnion.querySpec().offset().get(), isLiteral(20L));
    ...
    public void testUnion3Tables() throws Exception {
        ...
        assertThat(tableUnion1.querySpec().limit().get(), isLiteral(10L));
        assertThat(tableUnion1.querySpec().offset().get(), isLiteral(20L));
