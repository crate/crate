...
public class InOperatorTest {
    ...
    @Test
    public void testNormalizeSymbolIntegerSetIncluded() {
        IntegerLiteral inValue = new IntegerLiteral(1);
        IntegerSetLiteral inListValues = new IntegerSetLiteral (
            new HashSet<IntegerLiteral>(
                Arrays.asList(
    ...
    @Test
    public void testNormalizeSymbolIntegerSetNotIncluded() {
