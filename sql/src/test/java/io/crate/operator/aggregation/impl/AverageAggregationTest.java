...
public class AverageAggregationTest extends AggregationTest {
    ...
    private Object[][] executeAggregation(DataType dataType) throws Exception {
        return executeAggregation("avg", dataType);
    }
    ...
    public void testUnsupportedType() throws Exception {
        ...
        expectedException.expectMessage("AggregationFunction implementation not found [FunctionIdent{name=avg, argumentTypes=[string]}]");
