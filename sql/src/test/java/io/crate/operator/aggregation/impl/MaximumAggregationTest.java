...
public class MaximumAggregationTest extends AggregationTest {
    ...
    private Object[][] executeAggregation(DataType dataType) throws Exception {
        return executeAggregation("max", dataType);
    }

    @Test
    public void testReturnType() throws Exception {
        FunctionIdent fi = new FunctionIdent("max", ImmutableList.of(DataType.INTEGER));
    ...
    public void testUnsupportedType() throws Exception {
        ...
        expectedException.expectMessage("AggregationFunction implementation not found [FunctionIdent{name=max, argumentTypes=[object]}]");
