            ...
            switch (distributionType) {
                ...
                case MODULO:
                    ...
                    if (ramAccounting == null) {
                        ...
                        RowConsumer distributingConsumer = distributingConsumerFactory.create(
                            nodeOperation, accounting, phase.distributionInfo(), jobId(), pageSize);
                        ListenableRowConsumer listenableRowConsumer = new ListenableRowConsumer(distributingConsumer);
                        listenableRowConsumer.completionFuture().whenComplete((res, err) -> accounting.close());
                        consumer = listenableRowConsumer;
                    } else {
