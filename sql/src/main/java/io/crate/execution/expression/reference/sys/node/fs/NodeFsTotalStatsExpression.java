...
import static io.crate.execution.expression.reference.sys.node.fs.NodeFsStatsExpression.AVAILABLE;
import static io.crate.execution.expression.reference.sys.node.fs.NodeFsStatsExpression.BYTES_READ;
import static io.crate.execution.expression.reference.sys.node.fs.NodeFsStatsExpression.BYTES_WRITTEN;
import static io.crate.execution.expression.reference.sys.node.fs.NodeFsStatsExpression.READS;
import static io.crate.execution.expression.reference.sys.node.fs.NodeFsStatsExpression.SIZE;
import static io.crate.execution.expression.reference.sys.node.fs.NodeFsStatsExpression.USED;
import static io.crate.execution.expression.reference.sys.node.fs.NodeFsStatsExpression.WRITES;
