...
import io.crate.es.action.admin.indices.shrink.ResizeRequest;
import io.crate.es.action.admin.indices.shrink.ResizeResponse;
...
import static io.crate.es.cluster.metadata.IndexMetaData.INDEX_BLOCKS_WRITE_SETTING;
