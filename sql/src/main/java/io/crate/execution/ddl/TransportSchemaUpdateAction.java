        ...
        for (Map.Entry<String, Object> updateEntry : mappingUpdate.entrySet()) {
            ...
            if (source.containsKey(key)) {
                ...
                if (sourceValue instanceof Map && updateValue instanceof Map) {
                    ...
                    if (sourceValue instanceof Boolean || updateValue instanceof Boolean) {
                        sourceValue = DataTypes.BOOLEAN.value(sourceValue);
                        updateValue = DataTypes.BOOLEAN.value(updateValue);
                    }
