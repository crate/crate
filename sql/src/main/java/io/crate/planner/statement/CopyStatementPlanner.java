...
public class CopyStatementPlanner {
    ...
    public Plan planCopyFrom(CopyFromAnalyzedStatement copyFrom, Planner.Context context) {
        ...
        InputCreatingVisitor.Context inputColsContext = new InputCreatingVisitor.Context(toCollect);
        Symbol clusteredByInputCol = null;
        if (clusteredBy != null) {
            clusteredByInputCol = InputCreatingVisitor.INSTANCE.process(table.getReference(clusteredBy), inputColsContext);
        }
        SourceIndexWriterProjection sourceIndexWriterProjection = new SourceIndexWriterProjection(
            ...
            table.primaryKey(),
            InputCreatingVisitor.INSTANCE.process(table.partitionedByColumns(), inputColsContext),
            clusteredBy,
            copyFrom.settings(),
            null,
            excludes,
            InputCreatingVisitor.INSTANCE.process(primaryKeyRefs, inputColsContext),
            clusteredByInputCol,
