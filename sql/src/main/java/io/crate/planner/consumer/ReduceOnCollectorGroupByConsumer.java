...
public class ReduceOnCollectorGroupByConsumer implements Consumer {
    ...
    private static class Visitor extends AnalyzedRelationVisitor<ConsumerContext, PlannedAnalyzedRelation> {
        ...
        private PlannedAnalyzedRelation optimizedReduceOnCollectorGroupBy(QueriedDocTable table, DocTableRelation tableRelation, ConsumerContext context) {
            ...
            if (isRoot) {
                collectTopNLimit = firstNonNull(table.querySpec().limit(), Constants.DEFAULT_SELECT_LIMIT) + table.querySpec().offset();
            } else {
            ...
            int topNLimit = firstNonNull(table.querySpec().limit(), (isRoot ? Constants.DEFAULT_SELECT_LIMIT : TopN.NO_LIMIT));
