...
public final class ProjectorChain {

    private ProjectorChain() {
    }

    /**
     * Create a projector for each projection and chains them together.
     *
     * @return the first projector in the chain or {@param rowReceiver} if projections is empty.
     */
    public static RowReceiver prependProjectors(RowReceiver rowReceiver,
        ...
        if (previousProjector != null) {
            rowReceivers.add(rowReceiver);
            previousProjector.downstream(rowReceiver);
        }
