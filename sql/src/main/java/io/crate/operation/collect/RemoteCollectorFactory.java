...
public class RemoteCollectorFactory {
    ...
    public CrateCollector createCollector(String index,
        ...
        IndexShardRoutingTable shardRoutings = clusterService.state().routingTable().index(index).shard(shardId);
        ...
        CollectPhase newCollectPhase = createNewCollectPhase(childJobId, collectPhase, index, shardId, remoteNodeId);
    ...
    private CollectPhase createNewCollectPhase(
        UUID childJobId, CollectPhase collectPhase, String index, Integer shardId, String nodeId) {
