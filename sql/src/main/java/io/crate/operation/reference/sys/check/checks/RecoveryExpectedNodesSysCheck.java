...
public class RecoveryExpectedNodesSysCheck extends AbstractSysCheck {
    ...
    private static final String DESCRIPTION = "The number of nodes which should be waited for the" +
            " cluster recovery must be equal to the maximum number of nodes in the cluster";
    ...
    protected boolean validate(int clusterSize, int expectedNodes) {
        passed = ((clusterSize / 2) + 1) <= expectedNodes && expectedNodes <= clusterSize;
