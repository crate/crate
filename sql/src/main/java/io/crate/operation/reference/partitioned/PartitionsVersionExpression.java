...
public class PartitionsVersionExpression extends RowCollectNestedObjectExpression<PartitionInfo> {
    ...
    private void addChildImplementations() {
        childImplementations.put(Version.Properties.CREATED.toString(),
            new PartitionVersionCreatedExpression(Version.Properties.CREATED.toString()));
        childImplementations.put(Version.Properties.UPGRADED.toString(),
            new PartitionVersionCreatedExpression(Version.Properties.UPGRADED.toString()));
    }
    ...
    static class PartitionVersionCreatedExpression extends RowCollectNestedObjectExpression<PartitionInfo> {

        PartitionVersionCreatedExpression(String property) {
        ...
        private void addChildImplementations(String property) {
            childImplementations.put(Version.CRATEDB_VERSION_KEY,
                new PartitionDetailedVersionExpression(property, Version.CRATEDB_VERSION_KEY));
            childImplementations.put(Version.ES_VERSION_KEY,
                new PartitionDetailedVersionExpression(property, Version.ES_VERSION_KEY));
        }
    ...
    static class PartitionDetailedVersionExpression extends RowContextCollectorExpression<PartitionInfo, Object> {

        private final String property;
        private final String dbKey;

        PartitionDetailedVersionExpression(String property, String dbKey) {
