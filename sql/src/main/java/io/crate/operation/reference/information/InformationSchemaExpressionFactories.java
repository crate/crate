...
public class InformationSchemaExpressionFactories {
    ...
    public static Map<ColumnIdent, RowCollectExpressionFactory<ColumnContext>> columnsFactories() {
        return ImmutableMap.<ColumnIdent, RowCollectExpressionFactory<ColumnContext>>builder()
            ...
            .put(InformationColumnsTableInfo.Columns.NUMERIC_PRECISION, InformationColumnsExpression.ColumnsNullExpression::new)
            .put(InformationColumnsTableInfo.Columns.NUMERIC_PRECISION_RADIX, InformationColumnsExpression.ColumnsNullExpression::new)
            .put(InformationColumnsTableInfo.Columns.NUMERIC_SCALE, InformationColumnsExpression.ColumnsNullExpression::new)
            .put(InformationColumnsTableInfo.Columns.DATETIME_PRECISION, InformationColumnsExpression.ColumnsNullExpression::new)
