...
public class DropUserDefinedFunctionRequest extends MasterNodeRequest<CreateUserDefinedFunctionRequest> {
    ...
    public DropUserDefinedFunctionRequest(Integer signature, boolean ifExists) {
    ...
    public ActionRequestValidationException validate() {
        if (signature == null) {
            return ValidateActions.addValidationError("signature is missing", null);
        }
        return null;
    }
