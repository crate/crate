...
public class ToFloatFunction extends ToPrimitiveFunction<Float> {

    public static final String NAME = "toFloat";

    public static void register(ScalarFunctionModule module) {
        module.register(NAME, new Resolver());
    }

    public ToFloatFunction(FunctionInfo info) {
        super(info);
    }
    ...
    private static class Resolver implements DynamicFunctionResolver {
        ...
        public FunctionImplementation<Function> getForTypes(List<DataType> dataTypes) throws IllegalArgumentException {
            ...
            Preconditions.checkArgument(DataTypes.PRIMITIVE_TYPES.contains(dataTypes.get(0)),
                    "invalid datatype %s for float conversion", dataTypes.get(0));
