...
public class ToLongArrayFunction extends ToArrayFunction<Long> {
    ...
    private static final DataType longArrayType = new ArrayType(DataTypes.LONG);
    ...
    private static class Resolver implements DynamicFunctionResolver {
        ...
        public FunctionImplementation<Function> getForTypes(List<DataType> dataTypes) throws IllegalArgumentException {
            ...
            return new ToLongArrayFunction(new FunctionInfo(new FunctionIdent(NAME, dataTypes), longArrayType));
        }
    }
}
