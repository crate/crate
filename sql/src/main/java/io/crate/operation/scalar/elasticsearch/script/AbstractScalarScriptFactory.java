...
public abstract class AbstractScalarScriptFactory implements NativeScriptFactory {
    ...
    protected void prepare(@Nullable Map<String, Object> params) {
        fieldName = params == null ? null : XContentMapValues.nodeStringValue(params.get("field_name"), null);
        if (fieldName == null) {
            throw new ScriptException("Missing the field_name parameter");
        }

        String fieldTypeName = params == null ? null : XContentMapValues.nodeStringValue(params.get("field_type"), null);
        ...
        String operatorName = params == null ? null : XContentMapValues.nodeStringValue(params.get("op"), null);
        ...
        if (params != null && params.containsKey("args") && XContentMapValues.isArray(params.get("args"))) {
        ...
        if (operator == null) {
            throw new IllegalArgumentException(String.format("Cannot resolve operator with ident %s", operatorIdent));
        }
        ...
        if (function == null) {
            throw new IllegalArgumentException(String.format("Cannot resolve function with ident %s", functionIdent));
        }
    }
