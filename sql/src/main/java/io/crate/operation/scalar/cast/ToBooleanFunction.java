...
public class ToBooleanFunction extends ToPrimitiveFunction<Boolean> {
    ...
    public ToBooleanFunction(FunctionInfo info) {
        super(info);
    }
    ...
    private static class Resolver implements DynamicFunctionResolver {
        ...
        public FunctionImplementation<Function> getForTypes(List<DataType> dataTypes) throws IllegalArgumentException {
            ...
            Preconditions.checkArgument(DataTypes.PRIMITIVE_TYPES.contains(dataTypes.get(0)),
                    "invalid datatype %s for boolean conversion", dataTypes.get(0));
