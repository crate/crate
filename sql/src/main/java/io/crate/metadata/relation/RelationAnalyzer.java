...
public class RelationAnalyzer extends DefaultTraversalVisitor<AnalyzedRelation, Void> {

    private final ReferenceInfos referenceInfos;

    public RelationAnalyzer(ReferenceInfos referenceInfos) {
        this.referenceInfos = referenceInfos;
    }

    public AnalyzedRelation convert(Relation relation) {
        return process(relation, null);
    }

    @Override
    protected AnalyzedRelation visitTable(Table node, Void context) {
