...
public class GeoReferenceInfo extends ReferenceInfo {
    ...
    public static class Builder {
        ...
        public Builder treeLevels(@Nullable Integer treeLevels) {
            this.treeLevels = treeLevels;
            return this;
        }

        public Builder distanceErrorPct(@Nullable Double errorPct) {
        ...
        public GeoReferenceInfo build() {
            ...
            return new GeoReferenceInfo(ident, tree, precision, treeLevels, distanceErrorPct);
        }
