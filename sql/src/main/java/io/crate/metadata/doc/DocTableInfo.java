...
public class DocTableInfo implements TableInfo, ShardedTable {
    ...
    public Routing getRouting(final WhereClause whereClause, @Nullable final String preference) {
        ...
        GroupShardsIterator shardIterators = getShardIterators(whereClause, preference, clusterService.state());
    ...
    private void fillLocationsFromShardIterators(Map<String, Map<String, List<Integer>>> locations,
        ...
        // un-initialized shards for partitioned tables can be skipped
        for (ShardIterator shardIterator : shardIterators) {
            ...
            /* Don't throw UnavailableShardsException for inActivate shards
             * By the time the shard is accessed it might have become active.
             * If not there is a retry or shard-wormhole
             */
            if (!shardRouting.active() && isPartitioned) {
                continue;
            }
