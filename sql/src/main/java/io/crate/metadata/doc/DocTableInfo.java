...
public class DocTableInfo implements TableInfo {
    ...
    public DocTableInfo(TableIdent ident,
        ...
        this.isPartitioned = Iterables.all(
                Arrays.asList(this.concreteIndices),
                new Predicate<String>() {
                    @Override
                    public boolean apply(@Nullable String input) {
                        try {
                            PartitionName.fromString(input,
                                    DocTableInfo.this.ident.name(),
                                    DocTableInfo.this.partitionedByColumns.size());
                            return true;
