...
import io.crate.execution.expression.reference.sys.shard.SysAllocation;
import io.crate.execution.expression.reference.sys.shard.SysAllocationDecisionsExpression;
...
public class SysAllocationsTableInfo extends StaticTableInfo {
    ...
    public static final TableIdent IDENT = new TableIdent(SysSchemaInfo.NAME, "allocations");
