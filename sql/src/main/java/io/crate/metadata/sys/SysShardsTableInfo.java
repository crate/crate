...
public class SysShardsTableInfo extends SysTableInfo {
    ...
    static {
        register(primaryKey.get(0).fqn(), DataType.STRING, null);
        register(primaryKey.get(1).fqn(), DataType.STRING, null);
        register(primaryKey.get(2).fqn(), DataType.INTEGER, null);
        register(primaryKey.get(3).fqn(), DataType.STRING, null);
