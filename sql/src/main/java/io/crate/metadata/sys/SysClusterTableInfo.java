...
public class SysClusterTableInfo extends StaticTableInfo {
    ...
    public SysClusterTableInfo(ClusterService clusterService) {
        super(IDENT, new ColumnRegistrar(IDENT, RowGranularity.CLUSTER)
                ...
                .register(ClusterSettingsExpression.NAME, DataTypes.OBJECT, ImmutableList.of(CrateSettings.UDF.name()))
                .register(ClusterSettingsExpression.NAME, DataTypes.BOOLEAN, ImmutableList.of(CrateSettings.UDF.name(),
                    CrateSettings.UDF_ENABLED.name())),
