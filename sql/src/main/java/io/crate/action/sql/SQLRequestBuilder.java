...
public class SQLRequestBuilder extends ActionRequestBuilder<SQLRequest, SQLResponse, SQLRequestBuilder, ElasticsearchClient> {

    public SQLRequestBuilder(ElasticsearchClient client) {
