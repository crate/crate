...
public class SQLOperations {
    ...
    public Session createSession(Function<AnalyzedRelation, ResultReceiver> rowReceiverFactory) {
    ...
    public class Session {
        ...
        private final Function<AnalyzedRelation, ResultReceiver> rowReceiverFactory;
        ...
        private Session(Executor executor, Function<AnalyzedRelation, ResultReceiver> rowReceiverFactory) {
