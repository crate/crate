...
public class TransportShardUpsertAction
    ...
    private final static AssignmentsReferenceToLiteralConverter ASSIGNMENT_TO_LITERAL_CONVERTER = new AssignmentsReferenceToLiteralConverter();
    ...
    private Symbol[] prepareUpdateAssignments(String[] columns, Symbol[] assignments) {
        ...
        return ASSIGNMENT_TO_LITERAL_CONVERTER.process(Lists.newArrayList(assignments), context)
