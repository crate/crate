...
public class AlterTableOperation {
    ...
    private CompletableFuture<Long> closeTable(String[] concreteIndices) {
        CloseIndexRequest request = new CloseIndexRequest(concreteIndices);
    ...
    private CompletableFuture<Long> openTable(String[] concreteIndices) {
        OpenIndexRequest request = new OpenIndexRequest(concreteIndices);
