...
public class UnionContext extends AbstractExecutionSubContext {

    private final UnionPhase unionPhase;

    public UnionContext(ESLogger logger, UnionPhase unionPhase, ListenableRowReceiver targetRowReceiver) {
