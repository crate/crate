...
public class RelationAnalysisContext {
    ...
    private final StatementAnalysisContext statementContext;
    ...
    RelationAnalysisContext(StatementAnalysisContext statementContext, boolean aliasedRelation) {
    ...
    public ExpressionAnalyzer expressionAnalyzer() {
        if (expressionAnalyzer == null){
            expressionAnalyzer = new ExpressionAnalyzer(statementContext.analysisMetaData(),
                statementContext.parameterContext(), fieldProvider(), null);
        }
