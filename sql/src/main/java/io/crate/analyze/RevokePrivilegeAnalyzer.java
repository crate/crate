...
public class RevokePrivilegeAnalyzer {

    private final UserManager userManager;

    public RevokePrivilegeAnalyzer(UserManager userManager) {
        this.userManager = userManager;
    }

    public GrantRevokePrivilegeAnalyzedStatement analyze(RevokePrivilege node) {
