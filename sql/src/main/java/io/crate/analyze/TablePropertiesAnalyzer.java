...
public final class TablePropertiesAnalyzer {
    ...
    private static final ImmutableBiMap<String, String> CRATE_TO_ES_SETTINGS_MAP =
        ImmutableBiMap.<String, String>builder()
            ...
            .put(stripIndexPrefix(TableParameterInfo.READ_ONLY_ALLOW_DELETE), TableParameterInfo.READ_ONLY_ALLOW_DELETE)
    ...
    private static final ImmutableMap<String, SettingsApplier> SETTINGS_APPLIER =
        ImmutableMap.<String, SettingsApplier>builder()
            ...
            .put(TableParameterInfo.READ_ONLY_ALLOW_DELETE, new SettingsAppliers.BooleanSettingsApplier(CrateTableSettings.READ_ONLY_ALLOW_DELETE))
