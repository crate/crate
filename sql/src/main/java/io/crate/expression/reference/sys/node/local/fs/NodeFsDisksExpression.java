...
package io.crate.expression.reference.sys.node.local.fs;
...
class NodeFsDisksExpression extends SysObjectArrayReference {
    ...
    @Override
    protected List<io.crate.expression.reference.NestedObjectExpression> getChildImplementations() {
        List<io.crate.expression.reference.NestedObjectExpression> diskRefs = new ArrayList<>();
