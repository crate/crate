...
public class ExceptionHelper {
     ...
     * Also transform throwable to {@link CrateException}.
     *
     * @param e
     * @return
     */
    ...
    /**
     * Throws an {@link CrateException} if a
     ...
     * Intention is that we want to response a valid {@link io.crate.action.sql.SQLResponse}
