...
/**
 * used to parse the "stmt" element that is expected to be in requests parsed by the {@link crate.elasticsearch.action.sql.parser
 * .SQLXContentSourceParser}
 * <p/>
 * Fills the stmt in the {@link crate.elasticsearch.action.sql.parser.SQLXContentSourceContext}.
 */
