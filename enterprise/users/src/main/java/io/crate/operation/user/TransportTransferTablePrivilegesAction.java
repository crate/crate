...
@Singleton
public class TransportTransferTablePrivilegesAction extends TransportMasterNodeAction<TransferTablePrivilegesRequest, TransferTablePrivilegesResponse> {
    ...
    @Override
    protected TransferTablePrivilegesResponse newResponse() {
        return new TransferTablePrivilegesResponse();
    }
    ...
    @Override
    protected void masterOperation(TransferTablePrivilegesRequest request, ClusterState state, ActionListener<TransferTablePrivilegesResponse> listener) throws Exception {
        clusterService.submitStateUpdateTask("transfer_table_privileges",
            new AckedClusterStateUpdateTask<TransferTablePrivilegesResponse>(Priority.IMMEDIATE, request, listener) {
                ...
                @Override
                protected TransferTablePrivilegesResponse newResponse(boolean acknowledged) {
                    return new TransferTablePrivilegesResponse(acknowledged, affectedRows);
                }
            });
