...
public class MigrationToolTest extends CrateUnitTest {
    ...
    @Test
    public void testFilterIndexPaths() throws IOException {
        ...
        Map<String, List<File>> tableDirs = new HashMap<>();
        ...
        assertThat(tableDirs.get(tableNames[0]), containsInAnyOrder(dirs[0]));
        assertThat(tableDirs.get(tableNames[1]), containsInAnyOrder(dirs[1], dirs[2]));
        assertThat(tableDirs.get(tableNames[2]), containsInAnyOrder(dirs[3], dirs[4]));
    }
}
