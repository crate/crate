...
/**
 * Internal inout request executed directly against a specific index shard.
 */
class ShardSearchIntoRequest extends BroadcastShardOperationRequest {
