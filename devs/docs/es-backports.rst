...
- [s] 563b2736a9f Annotated text type should extend TextFieldType (#49555)
- [s] 7069045cd42 Add the simple strategy to cluster settings (#49414)
...
- [s] 47b49251eae Improve resiliency to auto-formatting in server (#48450)
- [s] 01030caf8e4 Allow realtime get to read from translog (#48843)
- [s] a0e3e943817 Send cluster name and discovery node in handshake (#48906) (Reverted in 139931af5b2)
- [x] d029e18c722 Closed shard should never open new engine (#47186)
- [s] 3ce7a37f1ff Remove index.force_memory_term_dictionary setting (#48873)
- [x] e0469a72199 Remove support for ancient corrupted markers (#48858)
- [d] a5f17fc2750 Add preflight check to dynamic mapping updates (#48817)
- [x] be6697f05a9 Remove Blocking Connect Methods from TransportService (#48841)
- [x] 6742d9c9d90 Cleanup Redundant Futures in Recovery Code (#48805)
- [s] 4c75564bd13 Return consistent source in updates (#48707)
