...
- [x] 48d31194c25 Always use primary term of operation in InternalEngine (#45083)
...
- [x] 7895dc99154 Convert Transport Request/Response to Writeable (#44636)
- [d] fd54e3e8244 Remove support for old translog checkpoint formats (#44272)
- [x] 22a30418649 Convert index and persistent actions/response to writeable (#44582)
- [x] bbe97b03a55 remove usages of #readOptionalStreamable, #readStreamableList. (#44578)
- [x] 06d89121f63 Remove type parameter from ParserContext (#44478)
- [d] c8ae530e7a6 Don't use index_phrases on graph queries (#44340)
- [s] 46c2d7224d6 Ensure field caps doesn't error on rank feature fields. (#44370)
- [x] ca9ee218eb5 Ensure replication response/requests implement writeable (#44392)
- [d] 33ad7928fbb Geo: extract dateline handling logic from ShapeBuilders (#44187)
- [x] c251450a2fe Throw TranslogCorruptedException in more cases (#44217)
- [x] cb3e0cbaa92 Fail engine if hit document failure on replicas (#43523)
- [s] a85199286de Support WKT point conversion to geo_point type (#44107)
- [s] be0df44b1ba Upgrade to lucene-8.2.0-snapshot-860e0be5378 (#44171)
- [x] 23b8185fdc9 Convert ReplicationResponse to Writeable (#43953)
- [x] b842ea8a8ae Some Cleanup in o.e.i.shard (#44097)
- [x] d01d831a196 Removed writeTo from TransportResponse and ActionResponse (#44092)
