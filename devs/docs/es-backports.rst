...
- [s] f07b90f3c35 Remove support for chained multi-fields. (#42333)
- [s] 4a08b3d1c94 remove 6.4.x version constants (#42127)
...
- [s] da1ba685b16 remove 6.3.x constants (#42087)
- [x] 4b21100178c Remove IndexStore and DirectoryService (#42446)
- [d] c459ea828f6 Remove node.max_local_storage_nodes (#42428)
- [x] cb402220d88 Remove deprecated Repository methods (#42359)
- [x] 4e999d7514e Upgrade to Lucene 8.1.0 (#42214)
- [x] 7ab59eef11f Some Cleanup in o.e.i.engine (#42278)
- [x] d22844208b2  Remove IndexShard dependency from Repository  (#42213)
- [s] e5722145a62 Remove the 6.7 version constants. (#42039)
