...
- [x] 16fae5d66d3 Also reroute after shard snapshot size fetch failure (#66008)
- [s] 26d67c1662d Ensure notify when proxy connections disconnect (#65697)
- [x] 745f527feac Deduplicate Index Meta Generations when Deserializing (#65619) (#65666)
- [x] 6bbeedc9321 Reset Deflater/Inflater after Use in DeflateCompressor (#65617) (#65646)
- [s] 0137c1679bb Fix the earliest last modified age of translog stats (#64753)
...
- [x] 7ea44d20c3c Try to fix DiskThresholdDeciderIT (#63614) (#63721)
