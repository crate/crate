...
- Fixed an authorization issue for ``_blobs`` HTTP endpoint. For more details
  please the `Security advisory`_.


.. _Security advisory: https://github.com/crate/crate/security/advisories/GHSA-2xv8-gjwh-fv8p
