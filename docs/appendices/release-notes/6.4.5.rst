...
- Fixed an issue where :ref:`ORDER BY <sql-select-order-by>` reads
  :ref:`REAL <type-real>` and :ref:`DOUBLE PRECISION <type-double-precision>`
  values of ``Infinity`` as ``NULL``
