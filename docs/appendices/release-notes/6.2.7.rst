...
.. NOTE::
    ...
    In development. 6.2.7 isn't released yet. These are the release notes for
    the upcoming release.

.. NOTE::

    If you are upgrading a cluster, you must be running CrateDB 5.0.0 or higher
    before you upgrade to 6.2.7.

    We recommend that you upgrade to the latest 6.1 release before moving to
    6.2.7.

    A rolling upgrade from >= 6.1.2 to 6.2.7 is supported. Doing a rolling
