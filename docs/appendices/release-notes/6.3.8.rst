...
.. NOTE::
    ...
    In development. 6.3.8 isn't released yet. These are the release notes for
    the upcoming release.

.. NOTE::

    If you are upgrading a cluster, you must be running CrateDB 5.0.0 or higher
    before you upgrade to 6.3.8.

    We recommend that you upgrade to the latest 6.2 release before moving to
    6.3.8.

    A rolling upgrade from >= 6.2.0 to 6.3.8 is supported.
