...
- The :ref:`stddev_pop() <aggregation-stddev-pop>`, :ref:`stddev_samp()
  ...
  stable algorithm that also improves precision for large-magnitude inputs.
  Because this changes the internal partial-aggregation state, during a rolling
  upgrade these aggregations cannot be used until all nodes have been upgraded
  to 6.5.0.
