...
optimizer. An example output looks like this::
    ...
    |                                                      |     └ Join[CROSS] (rows=108)                                                               |
    |                                                      |       ├ Collect[doc.employees | [id, name, surname, dept_id, sex] | true] (rows=18)        |
    |                                                      |       └ Collect[doc.departments | [id, name, manager_id, location] | true] (rows=6)        |
    ...
    |                                                      |   └ HashJoin[INNER | (dept_id = id)] (rows=3)                                              |
    |                                                      |     ├ Collect[doc.employees | [id, name, surname, dept_id, sex] | true] (rows=18)          |
    |                                                      |     └ Collect[doc.departments | [id, name, manager_id, location] | (name = 'IT')] (rows=1) |
