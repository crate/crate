...
**ALLOCATE STALE PRIMARY**
  ...
  corrupted shard using the :ref:`cli-crate-node` CLI tool.
...
**ALLOCATE EMPTY PRIMARY**
  ...
  a corrupted shard using the :ref:`cli-crate-node` CLI tool.

  Depending on the corruption of the shard, the :ref:`cli-crate-node` CLI tool
