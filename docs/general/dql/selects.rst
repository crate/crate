...
.. NOTE::
    ...
    the array can be 8192. To be use larger arrays, you must configure the
...
.. NOTE::
    ...
    default maximum size of the array can be 8192. To be use larger arrays, you
...
The ``HAVING`` clause is the equivalent to the where clause for the resulting
rows of a group by clause.
