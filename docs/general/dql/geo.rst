...
.. NOTE::
   ...
   wider than 180 degrees the CrateDB geoshape validator will convert it into a
   multipolygon consisting of 2 rectangular shapes covering the narrower area
...
precision`` array with lon and lat as seen above or as `WKT`_ string.
...
:disjoint:
  If the two shapes share no single point and not area, they are disjoint. This
