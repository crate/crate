...
|                  | Always `NULL`. This exists for backward     |             |
|                  | compatibility.                              |             |
+------------------+---------------------------------------------+-------------+
| ``name``         | The cluster name.                           | ``TEXT``    |
+------------------+---------------------------------------------+-------------+
| ``master_node``  | Node ID of the node which currently         | ``TEXT``    |
|                  | operates as master.                         |             |
+------------------+---------------------------------------------+-------------+
| ``settings``     | The cluster settings.                       | ``OBJECT``  |
+------------------+---------------------------------------------+-------------+
| ``state``        | Base64 encoded cluster state. Only the      | ``TEXT``    |
|                  | ``crate`` superuser and users with ``AL``   |             |
|                  | permission can view the state.              |             |
|                  | This is mainly for CrateDB engineers to     |             |
|                  | debug issues.                               |             |
+------------------+---------------------------------------------+-------------+
...
+------------------------------+----------------------------------------------------+----------------------+
| ``total_affected_row_count`` | Total number of rows affected by the queries       | ``BIGINT``           |
+------------------------------+----------------------------------------------------+----------------------+
