...
@Seed("991C1014D4833E6C:1CDD059F87E0920B")
public class CustomBlobPathTest extends CrateIntegrationTest {
    ...
    public void testGlobalBlobPath() throws Exception {
        ...
        assertTrue(blobEnvironment.shardLocations(new ShardId(".blob_test", 0)).exists());
        assertTrue(blobEnvironment2.shardLocations(new ShardId(".blob_test", 1)).exists());
