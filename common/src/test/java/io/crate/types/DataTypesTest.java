...
public class DataTypesTest extends CrateUnitTest {
    ...
    public void test_compare_by_id_complex_types() {
        assertThat(compareTypesById(ObjectType.untyped(), DataTypes.INTEGER_ARRAY), is(false));
    ...
    public void test_compare_by_id_array_types_of_the_same_dimension() {
        ...
        assertThat(compareTypesById(DataTypes.STRING_ARRAY, DataTypes.INTEGER_ARRAY), is(false));
    }
