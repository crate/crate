...
public class CrateCommonPlugin extends Plugin {

    private final Settings settings;
    private final IndexEventListenerProxy indexEventListenerProxy;

    public CrateCommonPlugin(Settings settings) {
    ...
    public Collection<Module> createGuiceModules() {
        return Collections.singletonList(new CrateCommonModule(indexEventListenerProxy));
    }
