...
public class SnapshotsInProgressSerializationTests extends AbstractDiffableWireSerializationTestCase<Custom> {
    ...
    private Entry randomSnapshot() {
        ...
        return new Entry(snapshot, includeGlobalState, partial, randomState(shards), indices, templates,
                startTime, repositoryStateId, shards, null, VersionUtils.randomVersion(random()));
    }
