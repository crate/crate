...
public class BackgroundIndexer implements AutoCloseable {
     ...
     */
    public BackgroundIndexer(String table, SQLTransportExecutor client, int numOfDocs) {
        this(table, client, numOfDocs, RandomizedTest.scaledRandomIntBetween(2, 5));
    }
     ...
     */
    public BackgroundIndexer(String table, SQLTransportExecutor client, int numOfDocs, final int writerCount) {
        this(table, client, numOfDocs, writerCount, true, null);
    }
     ...
     */
    public BackgroundIndexer(final String table, final SQLTransportExecutor sqlExecutor, final int numOfDocs, final int writerCount,
                        ...
                        while (!stop.get()) {
                            if (batch) {
                                ...
                                for (int i = 0; i < batchSize; i++) {
                                    ...
                                    insertData[i] = new Object[] {id, generateValues(threadRandom) };
                                }
                                try {
    ...
    private String generateValues(Random random) throws IOException {
