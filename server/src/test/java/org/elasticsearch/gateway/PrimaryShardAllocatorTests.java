...
public class PrimaryShardAllocatorTests extends ESAllocationTestCase {
    ...
    public void testNoProcessPrimaryNotAllocatedBefore() {
        ...
        assertClusterHealthStatus(allocation, HealthStatus.YELLOW);
    }
    ...
    private void assertClusterHealthStatus(RoutingAllocation allocation, HealthStatus expectedStatus) {
