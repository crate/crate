...
public class FloatTypeTest extends ESTestCase {
    ...
    public void test_cast_long_to_real() {
        assertThat(FloatType.INSTANCE.implicitCast(123L, SESSION_SETTINGS), is(123.0f));
    }

    @Test
    public void test_cast_text_to_real() {
        assertThat(FloatType.INSTANCE.implicitCast("123", SESSION_SETTINGS), is(123.0f));
    }

    @Test
    public void test_cast_numeric_to_float() {
        assertThat(FloatType.INSTANCE.implicitCast(BigDecimal.valueOf(123.12), SESSION_SETTINGS), is(123.12F));
    }
    ...
    public void test_infinite_float_can_be_casted_to_infinite_float() throws Exception {
        assertThat(FloatType.INSTANCE.implicitCast(Float.POSITIVE_INFINITY, SESSION_SETTINGS), is(Float.POSITIVE_INFINITY));
        assertThat(FloatType.INSTANCE.implicitCast(Float.NEGATIVE_INFINITY, SESSION_SETTINGS), is(Float.NEGATIVE_INFINITY));
    }

    @Test
    public void test_infinite_double_can_be_casted_to_infinite_float() throws Exception {
        assertThat(FloatType.INSTANCE.implicitCast(Double.POSITIVE_INFINITY, SESSION_SETTINGS), is(Float.POSITIVE_INFINITY));
        assertThat(FloatType.INSTANCE.implicitCast(Double.NEGATIVE_INFINITY, SESSION_SETTINGS), is(Float.NEGATIVE_INFINITY));
    }

    @Test
    public void test_negative_max_float_value_can_be_casted_to_float() throws Exception {
        assertThat(FloatType.INSTANCE.implicitCast(-3.4028235e38d, SESSION_SETTINGS), is(- Float.MAX_VALUE));
        assertThat(FloatType.INSTANCE.implicitCast(-3.4028235e38f, SESSION_SETTINGS), is(- Float.MAX_VALUE));
    }
    ...
    public void test_cast_double_to_real_out_of_positive_range_throws_exception() {
        ...
        FloatType.INSTANCE.implicitCast(Double.MAX_VALUE, SESSION_SETTINGS);
    }
    ...
    public void test_cast_out_of_range_numeric_to_float_throws_exception() {
        ...
        FloatType.INSTANCE.implicitCast(new BigDecimal(Double.MAX_VALUE), SESSION_SETTINGS);
    }
    ...
    public void test_cast_boolean_to_real_throws_exception() {
        ...
        FloatType.INSTANCE.implicitCast(true, SESSION_SETTINGS);
    }
    ...
    public void test_cast_object_to_real_throws_exception() {
        ...
        FloatType.INSTANCE.implicitCast(Map.of(), SESSION_SETTINGS);
    }
}
