...
public class ColumnSketchBuilderTest extends ESTestCase {
    ...
    public void test_streaming() throws IOException {
        ...
        assertStreamOutInOk(sketch, support, Version.CURRENT);
        // In 6.4.5 and 6.5.0 we fixed an issue that required new fields.
        // See: https://github.com/crate/crate/pull/20172.
