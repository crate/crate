...
public class CreateAlterTableStatementAnalyzerTest extends CrateDummyClusterServiceUnitTest {
    ...
    public void testClusteredIntoNullShards() {
        ...
        BoundCreateTable analysis = analyze(
            "create table t (id int primary key) clustered into ? shards", (String) null);
    ...
    public void testBlobTableClusteredIntoNullShards() {
        // If number of shards is null, use default setting
        AnalyzedCreateBlobTable blobTable = analyze("create blob table my_table clustered into ? shards", (String) null);
    ...
    public void testCreateTableGeneratedColumnBasedOnGeneratedColumn() {
        assertThrowsMatches(
            ...
            "Validation failed for date_string: a generated column cannot be based on a generated column");
    }
    ...
    public void test_alter_table_add_generated_column_based_on_generated_column() throws IOException {
        ...
        assertThrowsMatches(
            () -> analyze(
                ...
                """),
            ColumnValidationException.class,
            "Validation failed for col3: a generated column cannot be based on a generated column");
    }
