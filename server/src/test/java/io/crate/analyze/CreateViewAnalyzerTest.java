...
public class CreateViewAnalyzerTest extends CrateDummyClusterServiceUnitTest {
    ...
    public void testCreateViewCreatesStatementWithNameAndAnalyzedRelation() {
        ...
        assertThat(createView.name()).isEqualTo(RelationName.of(e.getSessionSettings().searchPath().currentSchema(), "v1"));
    ...
    public void testCreateViewCreatesViewInDefaultSchema() {
        ...
        assertThat(createView.name()).isEqualTo(RelationName.of(sqlExecutor.getSessionSettings().searchPath().currentSchema(), "v1"));
    }
