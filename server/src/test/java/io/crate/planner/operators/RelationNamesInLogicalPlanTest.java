...
public class RelationNamesInLogicalPlanTest extends CrateDummyClusterServiceUnitTest {
    ...
    public void setup() throws Exception {
        ...
        var t1Collect = new Collect(1, t1Relation, List.of(x), WhereClause.MATCH_ALL);
        ...
        var t2Collect = new Collect(3, t2Relation, List.of(x), WhereClause.MATCH_ALL);
    ...
    public void test_relationnames_are_based_on_sources_in_collect() {
        var collect = new Collect(1, t1Relation, List.of(), new WhereClause(null));
    ...
    public void test_relationnames_are_based_on_sources_in_get() {
        var get = new Get(1, t1Relation, new DocKeys(List.of(List.of()), false, false, 1, null), null, List.of());
