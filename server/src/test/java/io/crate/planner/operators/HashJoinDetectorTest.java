...
public class HashJoinDetectorTest extends CrateDummyClusterServiceUnitTest {
    ...
    public void testPossibleOnInnerContainingEqCondition() {
        ...
        assertThat(HashJoinDetector.isHashJoinPossible(JoinType.INNER, joinCondition)).isTrue();
    }
    ...
    public void testNotPossibleOnInnerWithoutAnyEqCondition() {
        ...
        assertThat(HashJoinDetector.isHashJoinPossible(JoinType.INNER, joinCondition)).isFalse();
    }
    ...
    public void testNotPossibleIfNotAnInnerJoin() {
        assertThat(HashJoinDetector.isHashJoinPossible(JoinType.CROSS, null)).isFalse();

        Symbol joinCondition = sqlExpressions.asSymbol("t1.x = t2.y");
        assertThat(HashJoinDetector.isHashJoinPossible(JoinType.LEFT, joinCondition)).isFalse();
        assertThat(HashJoinDetector.isHashJoinPossible(JoinType.RIGHT, joinCondition)).isFalse();
        assertThat(HashJoinDetector.isHashJoinPossible(JoinType.FULL, joinCondition)).isFalse();
        assertThat(HashJoinDetector.isHashJoinPossible(JoinType.ANTI, joinCondition)).isFalse();
        assertThat(HashJoinDetector.isHashJoinPossible(JoinType.SEMI, joinCondition)).isFalse();
    }
