...
public class MoveConstantJoinConditionsBeneathNestedLoopTest extends CrateDummyClusterServiceUnitTest {
    ...
    public void test_optimize_nestedloopjoin_to_hashjoin_when_constant_can_be_pused_down() {
        ...
        Collect c1 = new Collect(t1, Collections.emptyList(), WhereClause.MATCH_ALL, 1, 1, txnCtx.idAllocator().nextId());
        Collect c2 = new Collect(t2, Collections.emptyList(), WhereClause.MATCH_ALL, 1, 1, txnCtx.idAllocator().nextId());
        ...
        NestedLoopJoin nl = new NestedLoopJoin(c1, c2, JoinType.INNER, joinCondition, false, t1, false, false, false, false, txnCtx.idAllocator().nextId());
