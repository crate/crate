...
public class PatternTest {
    ...
    public void test_with_source_matching() {
        Collect source = new Collect(mock(AbstractTableRelation.class), List.of(), WhereClause.MATCH_ALL, null);
    ...
    public void test_with_match_group_referenced_source() {
        var source = new Collect(mock(AbstractTableRelation.class), List.of(), WhereClause.MATCH_ALL, null);
    ...
    public void test_with_property_match_group_referenced_source() {
        ...
        Pattern<Filter> pattern = typeOf(Filter.class)
                                    ...
                                    .with(s -> s.params() == null).capturedAs(capture));
