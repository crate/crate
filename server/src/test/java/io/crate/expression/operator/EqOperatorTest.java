...
public class EqOperatorTest extends ScalarTestCase {
    ...
    public void test_numeric_type_equals_number_types() {
        assertEvaluate("numeric_4_2 = 1.111", false, Literal.ofUnchecked(NumericType.INSTANCE, new BigDecimal("1.11")));
        assertEvaluate("numeric_4_2 = 100", false, Literal.ofUnchecked(NumericType.INSTANCE, new BigDecimal("100.01")));
        assertEvaluate("numeric_4_2 = 100", true, Literal.ofUnchecked(NumericType.INSTANCE, new BigDecimal("100.00")));
        assertEvaluate(
            "numeric_4_2 = double_val",
            false,
            Literal.ofUnchecked(NumericType.INSTANCE, new BigDecimal("1.11")), Literal.of(1.111));
    }
}
