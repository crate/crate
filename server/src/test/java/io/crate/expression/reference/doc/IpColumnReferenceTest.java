...
public class IpColumnReferenceTest extends DocLevelExpressionsTest {
    ...
    public void testIpExpression() throws Exception {
        ...
        columnReference.setNextReader(new ReaderContext(readerContext, readerContext.reader()::document));
    ...
    public void testNullDocValuesDoNotResultInNPE() throws IOException {
        ...
        ref.setNextReader(new ReaderContext(readerContext, readerContext.reader()::document));
        ref.setNextDocId(0);
