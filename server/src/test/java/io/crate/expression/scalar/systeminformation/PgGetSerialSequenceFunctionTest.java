...
public class PgGetSerialSequenceFunctionTest extends ScalarTestCase {
    ...
    public void testPgGetExprWithFQNFunctionName() throws Exception {
        assertNormalize("pg_catalog.pg_get_serial_sequence('some_table', 'some_column')", isLiteral(null));
    }
}
