...
public class StringCaseFunctionTest extends ScalarTestCase {
    ...
    public void testEvaluateLowerFunc() throws Exception {
        assertEvaluate("lower(name)", "abcdefghijklmnopqrstuvwxyzäöüαβγ",
            Literal.of(DataTypes.STRING, "ABCDEFGHIJKLMNOPQRSTUVWXYZÄÖÜΑΒΓ")
        );
    }
    ...
    public void testEvaluateUpperFunc() throws Exception {
        assertEvaluate("upper(name)", "ABCDEFGHIJKLMNOPQRSTUVWXYZÄÖÜΑΒΓ",
            Literal.of(DataTypes.STRING, "abcdefghijklmnopqrstuvwxyzäöüαβγ")
        );
    }
