...
public class StartsWithFunctionQueryTest extends LuceneQueryBuilderTest {
    ...
    @Test
    public void test_starts_with_on_non_indexed_column_returns_null() {
    ...
    @Test
    public void test_starts_with_on_non_indexed_and_columnstore_disabled_returns_null() {
        Query query = convert("starts_with(a4, 'abc')");
        assertThat(query).hasToString("starts_with(a4, 'abc')");
    }

    @Test
    public void test_starts_with_with_non_literal_argument_returns_null() {
