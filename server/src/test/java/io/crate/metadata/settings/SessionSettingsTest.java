...
public class SessionSettingsTest {
    ...
    public void testSessionSettingsStreaming() throws IOException {
        SessionSettings s1 = new SessionSettings("user", SearchPath.createSearchPathFrom("crate"), true, false, 20, false);
    ...
    public void testSessionSettingsStreamingFrom4_6_0() throws IOException {
        SessionSettings s1 = new SessionSettings("user", SearchPath.createSearchPathFrom("crate"), true, false, 10, true);
        BytesStreamOutput out = new BytesStreamOutput();
