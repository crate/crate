...
public class TransportPrivilegesTest extends ESTestCase {
    ...
    public void testApplyPrivilegesCreatesNewPrivilegesInstance() {
        ...
        //when
        TransportPrivileges.applyPrivileges(rolesMap::values, mdBuilder, denyPrivilegeRequest);
    ...
    public void testValidateUserNamesEmptyUsers() throws Exception {
        ...
        List<String> unknownRoleNames = TransportPrivileges.validateRoleNames(new RolesMetadata(), roleNames);
    ...
    public void testValidateUserNamesMissingUser() throws Exception {
        List<String> roleNames = List.of("Ford", "Arthur");
        List<String> unknownRoleNames = TransportPrivileges.validateRoleNames(
    ...
    public void test_validate_response_when_roles_do_not_exist() {
        ...
        var result = TransportPrivileges.applyPrivileges(DUMMY_USERS_AND_ROLES::values, mdBuilder, privilegeReq);
        ...
        result = TransportPrivileges.applyPrivileges(DUMMY_USERS_AND_ROLES::values, mdBuilder, privilegeReq);
        assertThat(result.affectedRows()).isEqualTo(-1);
    ...
    public void test_grant_revoke_user_to_another_user_is_not_allowed() {
        ...
        for (var state : List.of(Policy.GRANT, Policy.REVOKE)) {
            ...
            assertThatThrownBy(() ->
                TransportPrivileges.applyPrivileges(DUMMY_USERS_AND_ROLES::values, mdBuilder, privilegeReq))
    ...
    public void test_grant_role_which_creates_cycle_is_not_allowed() {
        ...
        assertThatThrownBy(() ->
            TransportPrivileges.detectCyclesInRolesHierarchy(roles::values, privilegeReq1))
            .isExactlyInstanceOf(IllegalArgumentException.class)
        ...
        assertThatThrownBy(() ->
            TransportPrivileges.detectCyclesInRolesHierarchy(roles::values, privilegeReq2))
            .isExactlyInstanceOf(IllegalArgumentException.class)
