...
public class OpenTableRequestTest {
        ...
        for (var request : requests) {
            {
                ...
                try (var in = out.bytes().streamInput()) {
                    OpenTableRequest deserializedRequest = new OpenTableRequest(in);
                    assertThat(deserializedRequest.relation()).isEqualTo(relation);
