...
@LogicalReplicationITestCase.PublisherClusterScope(minNumDataNodes = 1, maxNumDataNodes = 1, supportsDedicatedMasters = false)
@LogicalReplicationITestCase.SubscriberClusterScope(minNumDataNodes = 1, maxNumDataNodes = 1, supportsDedicatedMasters = false)
