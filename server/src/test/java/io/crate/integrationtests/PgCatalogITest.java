...
public class PgCatalogITest extends IntegTestCase {
    ...
    public void testPgSettingsTable() {
        ...
        assertThat(response).hasRows(
            ...
            "optimizer_extract_constant_join_conditions_to_filter| true| Indicates if the optimizer rule ExtractConstantJoinConditionsToFilter is activated.| NULL| NULL",
