...
public class Http3DisabledIntegrationTest extends Http3IntegrationTest {
    ...
    @Test
    public void test_https_only_client_has_no_alt_svc() throws Exception {
    ...
    @Test
    public void test_explicit_http3_client_cannot_connect() {
