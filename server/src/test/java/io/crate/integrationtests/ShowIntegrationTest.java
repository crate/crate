...
public class ShowIntegrationTest extends SQLIntegrationTestCase {
    ...
    public void testShowAll() {
        ...
        assertThat(printedTable(response.rows()), is(
            ...
            "optimizer_rewrite_count_on_object_to_count_on_not_null_non_object_sub_column| true| Indicates if the optimizer rule RewriteCountOnObjectToCountOnNotNullNonObjectSubColumn is activated.\n" +
