...
public class ShowIntegrationTest extends IntegTestCase {
    ...
    public void testShowAll() {
        ...
        assertThat(response).hasRows(
            ...
            "optimizer_move_equi_join_filter_into_inner_join| true| Indicates if the optimizer rule MoveEquiJoinFilterIntoInnerJoin is activated.",
            ...
            "optimizer_move_filter_beneath_multi_phase| true| Indicates if the optimizer rule MoveFilterBeneathMultiPhase is activated.",
            ...
            "optimizer_rewrite_distinct_agg_on_different_columns_to_join| true| Indicates if the optimizer rule RewriteDistinctAggOnDifferentColumnsToJoin is activated.",
