...
public class IndexUpgraderTest extends SQLIntegrationTestCase {
    ...
    public void test_index_upgraders_fix_column_positions() throws Exception {
        startUpNodeWithDataDir("/indices/data_home/cratedata-4.6.0.zip"); // https://cdn.crate.io/downloads/releases/crate-4.6.0.tar.gz
        /*      Table 1) 'testing'
        ...
        assertThat(printedTable(response.rows()), is(expected));
