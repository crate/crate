...
public class SSLTransportITest extends SQLTransportIntegrationTest {
    ...
    public static void beforeIntegrationTest() throws Exception {
        keyStoreFile = Paths.get(SSLTransportITest.class.getClassLoader().getResource("keystore.jks").toURI());
        trustStoreFile = Paths.get(SSLTransportITest.class.getClassLoader().getResource("truststore.jks").toURI());
