...
public class UserAuthenticationMethodTest extends ESTestCase {
    ...
    public void testTrustAuthentication() throws Exception {
        ...
        assertThat(trustAuth.authenticate(Credentials.fromNameAndPassword("crate", null), null).name()).isEqualTo("crate");

        assertThatThrownBy(() -> trustAuth.authenticate(Credentials.fromNameAndPassword("cr8", null), null))
    ...
    public void testAlwaysOKAuthentication() throws Exception {
        ...
        assertThat(alwaysOkAuthMethod.authenticate(Credentials.fromNameAndPassword("crate", null), null).name()).isEqualTo("crate");

        assertThatThrownBy(() -> alwaysOkAuthMethod.authenticate(Credentials.fromNameAndPassword("cr8", null), null))
            .hasMessage("trust authentication failed for user \"cr8\"");
    }
    ...
    public void testPasswordAuthentication() throws Exception {
        ...
        assertThat(pwAuth.authenticate(Credentials.fromNameAndPassword("crate", "pw".toCharArray()), null).name()).isEqualTo("crate");
    }
    ...
    public void testPasswordAuthenticationWrongPassword() throws Exception {
        ...
        assertThatThrownBy(() -> pwAuth.authenticate(Credentials.fromNameAndPassword("crate", "wrong".toCharArray()), null))
    ...
    public void testPasswordAuthenticationForNonExistingUser() throws Exception {
        PasswordAuthenticationMethod pwAuth = new PasswordAuthenticationMethod(new CrateOrNullRoles());
        assertThatThrownBy(() -> pwAuth.authenticate(Credentials.fromNameAndPassword("cr8", "pw".toCharArray()), null))
