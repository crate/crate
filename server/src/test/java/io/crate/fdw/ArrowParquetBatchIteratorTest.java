...
public class ArrowParquetBatchIteratorTest extends CrateDummyClusterServiceUnitTest {
    ...
    public ArrowParquetBatchIteratorTest() throws URISyntaxException {
    }
    ...
    public void test_reads_all_records() throws Exception {
        ...
        ArrowParquetBatchIterator it = new ArrowParquetBatchIterator(parquetFile, columns);
        it.loadNextBatch();
        while (it.moveNext()) {
