...
public final class LogicalPlanAssert extends AbstractAssert<LogicalPlanAssert, LogicalPlan> {

    public LogicalPlanAssert(LogicalPlan actual) {
    ...
    public LogicalPlanAssert hasOperators(String ... operator) {
        ...
        assertThat(printContext.toString().split("\n"))
