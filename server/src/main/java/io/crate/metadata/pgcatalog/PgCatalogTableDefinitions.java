...
public final class PgCatalogTableDefinitions {
    ...
    public PgCatalogTableDefinitions(InformationSchemaIterables informationSchemaIterables,
        ...
        tableDefinitions.put(PgStatsTable.NAME, new StaticTableDefinition<>(
                ...
                (user, t) -> roles.hasAnyPrivilege(user, Privilege.Securable.TABLE, t.relation().fqn()),
        ...
        tableDefinitions.put(PgProcTable.IDENT, new StaticTableDefinition<>(
            ...
            (user, f) -> roles.hasAnyPrivilege(user, Privilege.Securable.SCHEMA, f.functionName.schema())
        ...
        tableDefinitions.put(PgNamespaceTable.IDENT, new StaticTableDefinition<>(
            ...
            (user, s) -> {
                if (roles.hasAnyPrivilege(user, Privilege.Securable.SCHEMA, s.name()) || isPgCatalogOrInformationSchema(s.name())) {
                    return true;
                }
                ...
                for (var view : s.getViews()) {
                    if (roles.hasAnyPrivilege(user, Privilege.Securable.VIEW, view.ident().fqn())) {
                        return true;
                    }
                }
                return false;
