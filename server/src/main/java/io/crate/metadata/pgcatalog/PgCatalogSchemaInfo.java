...
public class PgCatalogSchemaInfo implements SchemaInfo {
    ...
    public PgCatalogSchemaInfo(UserDefinedFunctionService udfService, TableStats tableStats) {
        ...
        tableInfoMap = Map.<String, TableInfo>ofEntries(
            ...
            Map.entry(PgAmopTable.NAME.name(), PgAmopTable.create()),
            Map.entry(PgAmprocTable.NAME.name(), PgAmprocTable.create()),
            Map.entry(PgShdescriptionTable.NAME.name(), PgShdescriptionTable.create()),
            Map.entry(PgAggregateTable.NAME.name(), PgAggregateTable.create()),
            Map.entry(PgAuthMembersTable.NAME.name(), PgAuthMembersTable.create()),
            Map.entry(PgAvailableExtensionsTable.NAME.name(), PgAvailableExtensionsTable.create()),
            Map.entry(PgEventTriggerTable.NAME.name(), PgEventTriggerTable.create()),
            Map.entry(PgExtensionTable.NAME.name(), PgExtensionTable.create()),
            Map.entry(PgConversionTable.NAME.name(), PgConversionTable.create()),
            Map.entry(PgCollationTable.NAME.name(), PgCollationTable.create()),
            Map.entry(PgForeignDataWrapperTable.NAME.name(), PgForeignDataWrapperTable.create()),
            Map.entry(PgForeignServerTable.NAME.name(), PgForeignServerTable.create()),
            Map.entry(PgLanguageTable.NAME.name(), PgLanguageTable.create()),
            Map.entry(PgTriggerTable.NAME.name(), PgTriggerTable.create()),
            Map.entry(PgTimezoneNamesTable.NAME.name(), PgTimezoneNamesTable.create()),
            Map.entry(PgTimezoneAbbrevsTable.NAME.name(), PgTimezoneAbbrevsTable.create()),
            Map.entry(PgRewriteTable.NAME.name(), PgRewriteTable.create()),
            Map.entry(PgForeignTable.NAME.name(), PgForeignTable.create()),
            Map.entry(PgOpclassTable.NAME.name(), PgOpclassTable.create()),
            Map.entry(PgOpfamilyTable.NAME.name(), PgOpfamilyTable.create()),
            Map.entry(PgOperatorTable.NAME.name(), PgOperatorTable.create()),
            Map.entry(PgPoliciesTable.NAME.name(), PgPoliciesTable.create()),
            Map.entry(PgSequenceTable.NAME.name(), PgSequenceTable.create()),
            Map.entry(PgUserMappingTable.NAME.name(), PgUserMappingTable.create()),
            Map.entry(PgDependTable.NAME.name(), PgDependTable.create()),
            Map.entry(PgInheritsTable.NAME.name(), PgInheritsTable.create()),
