...
public class DocTableInfo implements TableInfo, ShardedTable, StoredTable {
    ...
    public DocTableInfo(RelationName ident,
        ...
        boolean isClusteredBySysId = clusteredBy == null || clusteredBy.equals(DocSysColumns.ID.COLUMN);
        ...
        this.hasAutoGeneratedPrimaryKey =
            isClusteredBySysId
            && (this.primaryKeys.size() == 1 && this.primaryKeys.get(0).equals(DocSysColumns.ID.COLUMN))
