...
public final class InformationConstraintColumnUsageTable {
    ...
    public static SystemTable<Void> create() {
        return SystemTable.<Void>builder(IDENT)
            .add("table_catalog", STRING, ignored -> null)
            .add("table_schema", STRING, ignored -> null)
            .add("table_name", STRING, ignored -> null)
            .add("column_name", STRING, ignored -> null)
