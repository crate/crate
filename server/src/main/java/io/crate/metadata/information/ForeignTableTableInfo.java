...
public class ForeignTableTableInfo {
    ...
    public static SystemTable<RelationMetadata.ForeignTable> INSTANCE = SystemTable.<RelationMetadata.ForeignTable>builder(IDENT)
        ...
        .add("foreign_server_name", DataTypes.STRING, RelationMetadata.ForeignTable::server)
        .build();
}
