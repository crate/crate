...
class ClientMessages {
    ...
    static ByteBuf writeStartupMessage(ByteBuf buffer, String dbName) {
        return writeStartupMessage(buffer, dbName, Map.of());
    }

    static ByteBuf writeStartupMessage(ByteBuf buffer, String dbName, Map<String, String> properties) {
