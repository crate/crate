...
import io.crate.execution.ddl.tables.AlterColumnDefaultRequest;
...
public class AlterTableAlterColumnDefaultPlan implements Plan {

    private final AnalyzedAlterTableAlterColumnDefault analyzed;

    public AlterTableAlterColumnDefaultPlan(AnalyzedAlterTableAlterColumnDefault analyzed) {
