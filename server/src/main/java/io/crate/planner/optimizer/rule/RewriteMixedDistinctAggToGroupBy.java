...
import static io.crate.planner.optimizer.rule.RewriteDistinctAggToGroupBy.hasFilter;
...
public final class RewriteMixedDistinctAggToGroupBy implements Rule<HashAggregate> {
    ...
    /// Set to a ~12% cardinality ratio on the 7.7M-row `uservisits` table.
    @VisibleForTesting
    static final double MAX_TABLE_SIZE = 1_000_000;
