...
public class HashAggregate extends ForwardingLogicalPlan {
    ...
    HashAggregate(LogicalPlan source, List<Function> aggregates, LogicalPlanId id) {
        super(source, id);
    ...
    public LogicalPlan replaceSources(List<LogicalPlan> sources) {
        return new HashAggregate(Lists2.getOnlyElement(sources), aggregates, id);
    }
    ...
    public LogicalPlan pruneOutputsExcept(TableStats tableStats, Collection<Symbol> outputsToKeep) {
        ...
        return new HashAggregate(newSource, newAggregates, id);
    }
