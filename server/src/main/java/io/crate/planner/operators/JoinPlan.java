...
public class JoinPlan extends AbstractJoinPlan {
    ...
    private final boolean crossJoinEliminationRulePassed;
    ...
    public JoinPlan(LogicalPlan lhs,
                    ...
                    @Nullable Symbol joinCondition,
                    boolean isFiltered,
                    boolean crossJoinEliminationRulePassed) {
        super(lhs, rhs, joinCondition, joinType);
        this.isFiltered = isFiltered;
        this.crossJoinEliminationRulePassed = crossJoinEliminationRulePassed;
    }
    ...
    public boolean crossJoinEliminationRulePassed() {
        return crossJoinEliminationRulePassed;
    }
    ...
    public ExecutionPlan build(DependencyCarrier dependencyCarrier,
        ...
        throw new UnsupportedOperationException("JoinPlan can not be build, convert to Hash-join/NestedLoop Join instead");
    }
    ...
    public LogicalPlan pruneOutputsExcept(Collection<Symbol> outputsToKeep) {
        ...
        return new JoinPlan(
            ...
            joinCondition,
            isFiltered,
            crossJoinEliminationRulePassed
        );
    }
