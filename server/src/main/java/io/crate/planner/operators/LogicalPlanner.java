...
public class LogicalPlanner {
    ...
    public LogicalPlan planSubSelect(SelectSymbol selectSymbol, PlannerContext plannerContext) {
        ...
        LogicalPlan optimizedPlan = optimizer.optimize(maybeApplySoftLimit.apply(plan), plannerContext.planStats(), txnCtx,plannerContext::nextLogicalPlanId);
        optimizedPlan = joinOrderOptimizer.optimize(optimizedPlan, plannerContext.planStats(), txnCtx, plannerContext::nextLogicalPlanId);
    ...
    public LogicalPlan plan(AnalyzedRelation relation,
        ...
        return RewriteToQueryThenFetch.tryRewrite(relation, fetchOptimized, planStats.tableStats(), plannerContext::nextLogicalPlanId);
    }
