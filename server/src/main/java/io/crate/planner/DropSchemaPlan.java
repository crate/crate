...
import io.crate.metadata.DropSchemaRequest;
import io.crate.metadata.TransportDropSchema;
import io.crate.planner.operators.SubQueryResults;
import io.crate.sql.tree.DropSchema;

public class DropSchemaPlan implements Plan {

    private final AnalyzedDropSchema dropSchema;

    public DropSchemaPlan(AnalyzedDropSchema dropSchema) {
