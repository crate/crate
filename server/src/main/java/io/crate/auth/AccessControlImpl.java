...
public final class AccessControlImpl implements AccessControl {
    ...
    private static final class StatementVisitor extends AnalyzedStatementVisitor<Role, Void> {
        ...
        @Override
        protected Void visitAlterRepositoryAnalyzedStatement(AnalyzedAlterRepository analysis, Role user) {
            Privileges.ensureUserHasPrivilege(
                relationVisitor.roles,
                user,
                Permission.DDL,
        ...
        @Override
        public Void visitAlterTableAlterColumnDefault(AnalyzedAlterTableAlterColumnDefault alterTable, Role user) {
            ensureDDLOnTable(user, alterTable.table().fqn());
            return null;
        }
