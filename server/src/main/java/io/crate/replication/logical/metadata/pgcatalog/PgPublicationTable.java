...
public class PgPublicationTable {
    ...
    public static SystemTable<PublicationRow> INSTANCE = SystemTable.<PublicationRow>builder(IDENT)
    ...
    public static record PublicationRow(String name, Publication publication) {
