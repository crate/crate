...
/**
 * Periodically refresh {@link TableStatsService} based on {@link #refreshInterval}.
 */
@Singleton
public class UpdateTableStatsService implements Runnable {

    private static final Logger LOGGER = LogManager.getLogger(UpdateTableStatsService.class);
    ...
    @Inject
    public UpdateTableStatsService(Settings settings,
