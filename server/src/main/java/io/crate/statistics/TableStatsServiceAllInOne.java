 ...
 */
@Singleton
public class TableStatsServiceAllInOne extends AbstractLifecycleComponent implements Runnable, ClusterStateListener {
    ...
    public TableStatsServiceAllInOne(Settings settings,
