...
public class TransportDropUserMapping extends TransportMasterNodeAction<DropUserMappingRequest, AcknowledgedResponse> {
    ...
    @Override
    protected ClusterBlockException checkBlock(DropUserMappingRequest request, ClusterState state) {
