...
public class DropUserMappingTask extends AckedClusterStateUpdateTask<AcknowledgedResponse> {
    ...
    public ClusterState execute(ClusterState currentState) throws Exception {
        ...
        var updatedServers = servers.dropUser(request.server(), request.userName(), request.ifExists());
