...
public final class PgPostmasterStartTime extends Scalar<Long, Void> {
    ...
    @SafeVarargs
    @Override
    public final Long evaluate(TransactionContext txnCtx, NodeContext nodeContext, Input<Void>... args) {
        return nodeContext.serverStartTimeInMs();
    }
}
