...
public class UserDefinedFunctionService {
    ...
    public void updateImplementations(String schema, Stream<UserDefinedFunctionMetadata> userDefinedFunctions) {
        updateImplementations(schema, userDefinedFunctions, functions);
    }
    ...
    void validateFunctionIsNotInUseByGeneratedColumn(String schema,
        ...
        // The iteration of schemas/tables must happen on the function registry WITHOUT the UDF already removed.
        ...
        var functionsWithRemovedFunction = functions.copyOf();
        updateImplementations(schema, functionsMetadata.functionsMetadata().stream(), functionsWithRemovedFunction);
