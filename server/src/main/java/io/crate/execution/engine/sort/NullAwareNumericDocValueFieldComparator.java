...
public class NullAwareNumericDocValueFieldComparator extends NullAwareNumericFieldComparator {
    private SortedNumericDocValues docValues;

    private final String fieldName;

    NullAwareNumericDocValueFieldComparator(String fieldName, int numHits, boolean nullsAtMin,
            SortField.Type sortFieldType) {
        super(numHits, nullsAtMin, sortFieldType);
        this.fieldName = fieldName;
    }

    @Override
    protected void readDoc(int doc) throws IOException {
