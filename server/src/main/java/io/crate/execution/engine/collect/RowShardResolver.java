...
public class RowShardResolver {
    ...
    private final List<DataType<?>> pkDataTypes;
    ...
    public RowShardResolver(TransactionContext txnCtx,
        ...
        pkDataTypes = new ArrayList<>(pkColumns.size());
        for (ColumnIdent pk : pkColumns) {
            pkDataTypes.add(tableInfo.getReference(pk).valueType());
        }
    ...
    public void setNextRow(Row row) {
        ...
        id = idFunction.apply(pkValues, pkDataTypes);
