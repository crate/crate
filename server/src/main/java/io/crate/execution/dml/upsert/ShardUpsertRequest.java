...
public final class ShardUpsertRequest extends ShardRequest<ShardUpsertRequest, ShardUpsertRequest.Item> {
     ...
     */
    @Nullable
    private final ScopedRef[] insertColumns;
    ...
    public ShardUpsertRequest(
        ...
        @Nullable ScopedRef[] insertColumns,
    ...
    public ShardUpsertRequest(Schemas schemas, StreamInput in) throws IOException {
        ...
        if (missingAssignmentsColumnsSize > 0) {
            insertColumns = new ScopedRef[missingAssignmentsColumnsSize];
            if (in.getVersion().onOrAfter(Version.V_6_2_0)) {
                for (int i = 0; i < missingAssignmentsColumnsSize; i++) {
                    long oid = in.readLong();
                    ScopedRef ref = oid == Metadata.COLUMN_OID_UNASSIGNED
                ...
                for (int i = 0; i < missingAssignmentsColumnsSize; i++) {
                    insertColumns[i] = ScopedRef.fromStream(in);
                }
            }
    ...
    public void writeTo(StreamOutput out) throws IOException {
        ...
        if (insertColumns != null) {
            ...
            if (out.getVersion().onOrAfter(Version.V_6_2_0)) {
                for (ScopedRef reference : insertColumns) {
    ...
    @Nullable
    public ScopedRef[] insertColumns() {
    ...
    public static class Builder {
        ...
        @Nullable
        private final ScopedRef[] missingAssignmentsColumns;
        ...
        public Builder(SessionSettings sessionSettings,
                       ...
                       @Nullable ScopedRef[] missingAssignmentsColumns,
