...
public class TransportShardUpsertAction extends TransportShardAction<
        ...
        for (int retryCount = 0; retryCount < MAX_RETRY_LIMIT; retryCount++) {
            try {
                ...
                if (!fallBackToUpdate) {
                    ...
                    return indexItemForUpdate(onConflictIndexer, request, item, indexShard, tableInfo, partitionValues);
                }
    ...
    private IndexItemResult indexHelper(ParsedDocument parsedDocument,
                                        String id,
                                        Indexer indexer,
                                        IndexItem item,
                                        IndexShard indexShard,
