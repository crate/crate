...
import io.crate.metadata.ccr.PublicationsMetadata;
import io.crate.metadata.cluster.DDLClusterStateTaskExecutor;
import org.elasticsearch.cluster.ClusterState;
import org.elasticsearch.cluster.metadata.Metadata;

public class CreatePublicationStateExecutor extends DDLClusterStateTaskExecutor<CreatePublicationRequest> {
    ...
    protected ClusterState execute(ClusterState currentState,
        ...
        if (oldMetadata != null && oldMetadata.contains(request.name())) {
        ...
        newMetadata.put(request.name(), request.tables());
