...
public class ProjectionVisitor<C, R> {
    ...
    public R visitFileIndexWriterProjection(FileIndexWriterProjection projection, C context) {
        return visitProjection(projection, context);
    }

//    public R visitFileIndexWriterReturnSummaryProjection(FileIndexWriterReturnSummaryProjection projection, C context) {
//        return visitProjection(projection, context);
//    }
