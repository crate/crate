...
public class AlterTableAlterColumnDefaultAnalyzer {
    ...
    public AnalyzedAlterTableAlterColumnDefault analyze(AlterTableAlterColumnDefault<Expression> node,
        ...
        Symbol column = expressionAnalyzer.convert(node.column(), expressionContext);
        assert column instanceof Reference
            : "Parser restricts column expression to subscripts & qualified names";
