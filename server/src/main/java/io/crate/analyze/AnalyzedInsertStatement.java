...
public class AnalyzedInsertStatement implements AnalyzedStatement {
    ...
    AnalyzedInsertStatement(AnalyzedRelation subQueryRelation,
        ...
        if (clusteredBy == null) {
            ...
            List<Symbol> clusteredBySymbols = symbolsFromTargetColumnPositionOrGeneratedExpression(
                columnPositions,
                targetColumns,
                List.of(clusteredBy),
                generatedColumns,
            ...
            Symbol clusteredBySymbol = clusteredBySymbols.isEmpty() ? null : clusteredBySymbols.getFirst();
            this.clusteredBySymbol = clusteredBySymbol == Literal.NULL ? null : clusteredBySymbol;
        }
