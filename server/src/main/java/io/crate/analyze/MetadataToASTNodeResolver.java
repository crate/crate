        ...
        private List<ColumnDefinition<Expression>> extractColumnDefinitions(@Nullable ColumnIdent parent) {
            ...
            while (referenceIterator.hasNext()) {
                ...
                if (ref instanceof GeneratedReference generatedRef) {
                    ...
                    constraints.add(new GeneratedExpressionConstraint<>(generatedExpression, formattedExpression));
                }
                ...
                if (defaultExpr != null) {
                    ...
                    constraints.add(new DefaultConstraint<>(defaultExpression, symbol));
                }
