...
class AlterRepositoryAnalyzer {

    private final NodeContext nodeCtx;

    AlterRepositoryAnalyzer(NodeContext nodeCtx) {
        this.nodeCtx = nodeCtx;
    }

    public AnalyzedAlterRepository analyze(AlterRepository<Expression> alterRepository,
                                           ParamTypeHints paramTypeHints,
                                           CoordinatorTxnCtx txnCtx) {
        String repositoryName = alterRepository.repository();
