...
public class RetentionLeaseSyncAction extends
    ...
    @Override
    protected WritePrimaryResult<Request, ReplicationResponse> shardOperationOnPrimary(final Request request, final IndexShard primary) throws WriteStateException {
