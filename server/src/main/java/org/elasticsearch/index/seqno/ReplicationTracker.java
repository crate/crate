...
public class ReplicationTracker extends AbstractIndexShardComponent implements LongSupplier {
    ...
    public ReplicationTracker(
        ...
        this.hasAllPeerRecoveryRetentionLeases = indexSettings.getIndexVersionCreated().onOrAfter(Version.V_4_3_0);
     ...
     * a rolling upgrade from a version before {@link Version#V_4_3_0}, in which case the missing leases should be created asynchronously
    ...
    public synchronized void activateWithPrimaryContext(PrimaryContext primaryContext) {
        ...
        if (primaryContext.checkpoints.containsKey(shardAllocationId) == false) {
            ...
            assert indexSettings.getIndexVersionCreated().before(Version.V_4_3_0);
