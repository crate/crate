 ...
 */
public class RemoveCorruptedLuceneSegments {
    ...
    public Tuple<RemoveCorruptedShardDataCommand.CleanStatus, String> getCleanStatus(Directory indexDirectory,
        ...
        try (CheckIndex checker = new CheckIndex(indexDirectory, writeLock)) {
            ...
            if (status.missingSegments) {
                return new Tuple<>(RemoveCorruptedShardDataCommand.CleanStatus.UNRECOVERABLE,
                    "Index is unrecoverable - there are missing segments");
            }

            return status.clean
                ? new Tuple<>(markedCorrupted
                ...
                : new Tuple<>(RemoveCorruptedShardDataCommand.CleanStatus.CORRUPTED,
