...
public abstract class TransportSingleShardAction<Request extends SingleShardRequest<Request>, Response extends TransportResponse>
    ...
    private static final Logger LOGGER = LogManager.getLogger(TransportSingleShardAction.class);
    ...
    protected TransportSingleShardAction(String actionName,
        ...
        if (!isSubAction()) {
            transportService.registerRequestHandler(actionName, reader, ThreadPool.Names.SAME, new TransportHandler());
        }
        transportService.registerRequestHandler(transportShardAction, reader, ThreadPool.Names.SAME, new ShardTransportHandler());
    }
