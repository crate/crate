...
public final class TransportCleanupRepositoryAction extends TransportMasterNodeAction<CleanupRepositoryRequest, CleanupRepositoryResponse> {
    ...
    private static final Version MIN_VERSION = Version.V_4_2_0;
    ...
    public TransportCleanupRepositoryAction(TransportService transportService, ClusterService clusterService,
        ...
        super(CleanupRepositoryAction.NAME, transportService, clusterService, threadPool,
    ...
    @Override
    protected final void masterOperation(CleanupRepositoryRequest request, ClusterState state, ActionListener<CleanupRepositoryResponse> listener) throws Exception {
