...
public class ProxyConnectionStrategy extends RemoteConnectionStrategy {
     ...
     */
    public static final Setting<String> SERVER_NAME = Setting.simpleString(
        "server_name",
        new StrategyValidator<>("server_name", ConnectionStrategy.PROXY),
        Setting.Property.Dynamic);
    ...
    ProxyConnectionStrategy(String clusterAlias,
        ...
        this(
            ...
            SERVER_NAME.get(connectionSettings));
    }
    ...
    protected boolean strategyMustBeRebuilt(Settings newSettings) {
        ...
        String serverName = SERVER_NAME.get(newSettings);
