...
public final class ClusterShardHealth implements Writeable {
     ...
     */
    ClusterShardHealth(int shardId, HealthStatus status, int activeShards, int relocatingShards, int initializingShards,
     ...
     */
    public static HealthStatus getInactivePrimaryHealth(final ShardRouting shardRouting) {
