...
public class DiskThresholdDecider extends AllocationDecider {
    ...
    private DiskUsageWithRelocations getDiskUsage(RoutingNode node,
     ...
     */
    DiskUsage averageUsage(RoutingNode node, Map<String, DiskUsage> usages) {
        if (usages.size() == 0) {
    ...
    public static long getExpectedShardSize(ShardRouting shard,
        ...
        if (indexMetadata.getResizeSourceIndex() != null && shard.active() == false &&
            ...
            if (sourceIndexMeta != null) {
                ...
                for (IndexShardRoutingTable shardRoutingTable : routingTable.index(mergeSourceIndex.getUUID())) {
